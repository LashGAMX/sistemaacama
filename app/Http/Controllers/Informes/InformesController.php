...
class InformesController extends Controller
{
    ...
    public function pdfSinComparacion2($idSol)
    {
        ...
        //Recupera los límites de cuantificación del laboratorio de los parámetros del primer folio y los límites de la norma
