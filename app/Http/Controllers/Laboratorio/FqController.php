...
class FqController extends Controller
{
    ...
    public function liberarTodoGA(Request $res)
    {
        ...
        foreach ($muestras as $item) {
            ...
            $matraz = MatrazGA::where('Id_matraz', $item->Id_matraz)->first();
            $matraz->Estado = 0;
            $matraz->save();
        }
    ...
    public function exportPdfEspectro($idLote)
    {
        ...
        switch ($lote->Id_tecnica) {
            ...
            case 13: // Grasas Y Aceites
                ...
                $matraz = DB::table('ViewMatrazConMuestra')->where('Id_lote', $idLote)->get();
                $detalle = GrasasDetalle::where('Id_lote', $idLote)->first();

                $modelConControl = DB::table('ViewLoteDetalleGA')->where('Id_lote', $idLote)->where('Id_control', '!=', 1)->get();
                $modelSinControl = DB::table('ViewLoteDetalleGA')->where('Id_lote', $idLote)->where('Id_control', 1)->get();
                $data = array(
    ...
    public function exportPdfCapturaEspectro($idLote)
    {
        ...
        // var_dump($dataLote);
        $dataLote = LoteAnalisis::where('Id_lote', $id_lote)->first();
        ...
        if ($parametro->Id_parametro == 222 || $parametro->Id_parametro == 117) { //Boro
        ...
        } else if ($parametro->Id_parametro == 15) { //Fósforo Total
            $horizontal = 'P';
            $data = DB::table('ViewLoteDetalleEspectro')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
            ...
            if (!is_null($data)) {
                ...
                $htmlCaptura1 = view('exports.laboratorio.fq.espectro.fosforoTotal.capturaBody1', compact('textoProcedimiento', 'data', 'dataLength', 'curva', 'limiteC', 'limites', 'observaciones'));
            } else {
                $sw = false;
            }
        } else if ($parametro->Id_parametro == 2) { //POR REVISAR EN LA TABLA DE DATOS; Materia Flotante
            $horizontal = 'P';
            $data = DB::table('ViewLoteDetalleEspectro')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
        ...
        } else if ($parametro->Id_parametro == 87) { //Silice
            $horizontal = 'P';
            $data = DB::table('ViewLoteDetalleEspectro')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
        ...
        } else if ($parametro->Id_parametro == 79) { // Fenoles Totales
            $horizontal = 'P';
            $data = DB::table('ViewLoteDetalleEspectro')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
            ...
            if (!is_null($data)) {
                ...
                $htmlCaptura1 = view('exports.laboratorio.fq.espectro.nitratos.capturaBody1', compact('textProcedimiento', 'data', 'dataLength', 'curva', 'limiteC', 'limites', 'observaciones'));
            } else {
                $sw = false;
            }
            ...
            if (!is_null($data)) {
                ...
                $htmlCaptura1 = view('exports.laboratorio.fq.espectro.nitritos.capturaBody1', compact('textProcedimiento', 'data', 'dataLength', 'curva', 'limiteC', 'limites', 'observaciones'));
            } else {
                $sw = false;
            }
        } else if ($parametro->Id_parametro == 96) { // SAAM
            $horizontal = 'P';
            $data = DB::table('ViewLoteDetalleEspectro')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
            ...
            if (!is_null($data)) {
                ...
                $htmlCaptura1 = view('exports.laboratorio.fq.espectro.saam.capturaBody1', compact('textoProcedimiento', 'data', 'dataLength', 'curva', 'limiteC', 'limites', 'observaciones'));
            } else {
                $sw = false;
            }
        } else if ($parametro->Id_parametro == 95 || $parametro->Id_parametro == 143) { // Sulfatos
            $horizontal = 'L';
            $data = DB::table('ViewLoteDetalleEspectro')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
    ...
    public function exportPdfCapturaSolidos($idLote)
    {
        ...
        if (!is_null($textProcedimiento)) {
            ...
            if ($parametro->Id_parametro == 43) { //SDF
                ...
                if (!is_null($data)) {
                    ...
                    $paramSt = Parametro::where('Id_parametro', 98)->first();
            ...
            } else if ($parametro->Id_parametro == 3 || $parametro->Id_parametro == 94 || $parametro->Id_parametro == 293) { //s.s.
                $horizontal = 'P';
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
            ...
            } else if ($parametro->Id_parametro == 45) { //POR REVISAR EN LA TABLA DE DATOS; ssf
                $horizontal = 'P';
            ...
            } else if ($parametro->Id_parametro == 3 || $parametro->Id_parametro == 92) { //SST
                $horizontal = 'L';
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
            ...
            } else if ($parametro->Id_parametro == 46) { //ssv
                $horizontal = true;
            ...
            } else if ($parametro->Id_parametro == 9 || $parametro->Id_parametro == 93) { //st
                $horizontal = 'L';
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
            ...
            } else if ($parametro->Id_parametro == 47) { //stf
                $horizontal = 'P';
            ...
            } else if ($parametro->Id_parametro == 48) { //stv
                $horizontal = 'L';
            ...
            if ($parametro->Id_parametro == 43) { //SDF
                ...
                if (!is_null($data)) {
                    ...
                    //Recupera el nombre del parámetro solidos disueltos totales
                    $paramSdt = Parametro::where('Id_parametro', 88)->first();
                    $paramSdt2 = Parametro::where('Id_parametro', 44)->first();
                ...
                if (!is_null($data)) {
                    ...
                    //Recupera el nombre del parámetro solidos disueltos totales
                    $paramSt = Parametro::where('Id_parametro', 90)->first();
                    $paramSt2 = Parametro::where('Id_parametro', 92)->first();
            ...
            } else if ($parametro->Id_parametro == 3 || $parametro->Id_parametro == 94) { //S.S.
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
                ...
                $horizontal = 'P';
            } else if ($parametro->Id_parametro == 45) { //ssf
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
                ...
                if (!is_null($data)) {
                    ...
                    //Recupera el nombre del parámetro solidos disueltos totales
                    $paramSdt = Parametro::where('Id_parametro', 45)->first();
                ...
                $horizontal = 'P';
            } else if ($parametro->Id_parametro == 4 || $parametro->Id_parametro == 92) { //sst
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
                ...
                $horizontal = 'L';
            } else if ($parametro->Id_parametro == 90 || $parametro->Id_parametro == 93) { // st
                $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
        ...
        //Hoja 2
        $hoja2 = false;
        if ($parametro->Id_parametro == 90 || $parametro->Id_parametro == 93) { //st
            $mpdf->AddPage('', '', '', '', '', '', '', 35, 45, 6.5, '', '', '', '', '', -1, -1, -1, -1);
            $data = DB::table('ViewLoteDetalleSolidos')->where('Id_lote', $id_lote)->orderBy('Id_control', 'DESC')->get();
