    ...
    <table class="table table-hover table-striped">
        ...
        <tbody>
           <tr> 
               <td>{{$model->Per_min}}</td>
               <td>{{$model->Per_max}}</td>
               <td><button type="button" class="btn btn-primary" wire:click="setData('{{$model->ID_nmx201}}','{{$model->Per_min}}','{{$model->Per_max}}')" data-toggle="modal" data-target="#modalLimiteParametro"><i class="voyager-edit"></i> <span hidden-sm hidden-xs>editar</span> </button></td>
            </tr> 
        </tbody> 
    </table>
