<div>
    ...
    <div class="row">
        <div class="col-md-8">
            <button class="btn btn-success btn-sm" wire:click='btnCreate' data-toggle="modal"
                data-target="#modalNorma"><i class="voyager-plus"></i> Crear</button>
        </div>
        <div class="col-md-4">
    ...
    <table class="table table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if ($item->Id_tipo === 0 || is_null($item->Id_tipo))
                    No existe ese tipo
                    @elseif ($item->Id_tipo === 1)
                    Agua
                ...
                <td>
                    ...
                    <button class="btn btn-primary btn-sm" wire:click="showDetils('{{$item->Id_norma}}')"><i
                            class="voyager-external"></i> Ver</button>
    ...
    <div wire:ignore.self class="modal fade" id="modalNorma" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input wire:model='status' type="checkbox" class="custom-control-input"
                                            id="customSwitch1">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" wire:model='norma' class="form-control"
