    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <label for="">Rama</label>
          <input type="text" wire:model='rama' class="form-control" placeholder="Rama">
  ...
  @endif
    <table class="table table-hover table-striped">
        ...
        <tr>  
          ...
          <td>
            <button type="button" class="btn btn-primary" wire:click="setData('{{$item->Id_rama}}','{{$item->Rama}}')"  data-toggle="modal" data-target="#modalRama"><i class="voyager-edit"></i> <span hidden-sm hidden-xs>editar</span> </button>
          </td>
          {{-- </form>  --}}
        </tr>
    @endforeach
    ...
    <div wire:ignore.self class="modal fade" id="modalRama" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form wire:submit.prevent="store">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Modificar rama</h5>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <input type="text" wire:model="idRama" hidden>
                    <label for="">Rama</label>
                    <input type="text" wire:model='rama' class="form-control" placeholder="Rama">
                    @error('rama') <span class="text-danger">{{ $message  }}</span> @enderror
                </div>
