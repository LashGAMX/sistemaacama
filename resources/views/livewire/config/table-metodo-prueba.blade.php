<div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <label for="">Metodo prueba</label>
          <input type="text" wire:model='metodo' class="form-control" placeholder="Metodo prueba">
          @error('metodo') <span class="text-danger">{{ $message  }}</span> @enderror
      </div>
      <div class="col-md-4">
        <label for="">Clave metodo</label>
  ...
  @endif
    <table class="table table-hover table-striped">
        ...
        <tr>  
          ...
          <td>
            <button type="button" class="btn btn-primary" wire:click="setData('{{$item->Id_metodo}}','{{$item->Metodo_prueba}}','{{$item->Clave_metodo}}')"  data-toggle="modal" data-target="#modalMetodo"><i class="voyager-edit"></i> <span hidden-sm hidden-xs>editar</span> </button>
          </td>
          {{-- </form>  --}}
        </tr>
    @endforeach
    ...
    <div wire:ignore.self class="modal fade" id="modalMetodo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form wire:submit.prevent="store">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Modificar metodo de prueba</h5>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <input type="text" wire:model="idMetodo" hidden>
                    <label for="">Metodo de prueba</label>
                    <input type="text" wire:model='metodo' class="form-control" placeholder="Metodo de prueba">
                    @error('metodo') <span class="text-danger">{{ $message  }}</span> @enderror
                </div>
                <div class="col-md-12">
                    <label for="">Clave metodo</label>
