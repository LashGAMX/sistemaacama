    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <label for="">Tecnica</label>
          <input type="text" wire:model='tecnica' class="form-control" placeholder="Tecnica">
  ...
  @endif
    <table class="table table-hover table-striped">
        ...
        <tr>  
          ...
          <td>
            <button type="button" class="btn btn-primary" wire:click="setData('{{$item->Id_tecnica}}','{{$item->Tecnica}}')"  data-toggle="modal" data-target="#modalTecnica"><i class="voyager-edit"></i> <span hidden-sm hidden-xs>editar</span> </button>
          </td>
          {{-- </form>  --}}
        </tr>
    @endforeach
    ...
    <div wire:ignore.self class="modal fade" id="modalTecnica" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form wire:submit.prevent="store">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Modificar tecnica</h5>
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <input type="text" wire:model="idTecnica" hidden>
                    <label for="">Tecnica</label>
                    <input type="text" wire:model='tecnica' class="form-control" placeholder="Tecnica">
                    @error('tecnica') <span class="text-danger">{{ $message  }}</span> @enderror
                </div>
