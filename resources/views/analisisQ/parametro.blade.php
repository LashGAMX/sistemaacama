...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
      <button class="btn btn-success" id="btnCreate" data-toggle="modal" data-target="#modalParametro"><i
          class="fas fa-plus"></i> Crear</button>
    </div>
    <div class="col-md-12" id="divTabla">
      <table class="table" id="parametros">
        <thead>
          <tr>
            <th>Id</th>
            <th>Sucursal</th>
          ...
          <tr>
            ...
            <th><input type="text" placeholder="Buscar Sucursal" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar Rama" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar Parámetro" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar Unidad" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar Método" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar C. Método" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar Norma" class="form-control form-control-sm"></th>
            <th><input type="text" placeholder="Buscar Límite" class="form-control form-control-sm"></th>
