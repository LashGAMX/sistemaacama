  ...
  <div class="row">
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-md-6">
          <center>
            <!-- <div id="divUltimoLote" @if (env('AUDITORIA') == 1) hidden @endif></div> -->
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            Muestras seleccionadas: <input type="number" id="muestrasSeleccionadas"
              style="width: 50px;border:none;color:red">
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="tabAlcalinidad-tab" data-toggle="tab" data-target="#tabAlcalinidad"
              type="button" role="tab" aria-controls="tabAlcalinidad" aria-selected="false">Datos Alcalinidad</button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="tabAcidez-tab" data-toggle="tab" data-target="#tabAcidez" type="button"
              role="tab" aria-controls="tabAcidez" aria-selected="false">Datos Acidez</button>
          </li>
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade" id="coliformes" role="tabpanel" aria-labelledby="coliformes-tab">
            ...
            <label>Lectura 24 Horas: <input type="datetime-local" id="pruebaPresuntiva_lectura"></label><br>
            <label>Lectura 48 Horas: <input type="datetime-local" id="pruebaPresuntiva_lectura2"></label><br>
          ...
          <div class="tab-pane fade" id="dbo" role="tabpanel" aria-labelledby="dbo-tab">
            <div class="row">
              <div class="col-md-4">
                <label>Cantidad de agua en dilución en ltros preparado: <input class="form-control" type="text"
                    id="cantDilucion"></label>
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-4">
                <label>Estandares Preparado registrado en el folio: <input class="form-control" type="text"
                    id="dilucion"></label>
              </div>
              <div class="col-md-4">
          ...
          <div class="tab-pane fade" id="tabAlcalinidad" role="tabpanel" aria-labelledby="tabAlcalinidad-tab">
            <div class="row">
              <div class="col-md-6">
                ...
                <button id="btnSetNormalidadAlc" class="btn-info"><i class="fas fa-square-root-alt"></i>
                  Ejecutar</button>
          ...
          <div class="tab-pane fade" id="tabAcidez" role="tabpanel" aria-labelledby="tabAcidez-tab">
            <div class="row">
              <div class="col-md-6">
                <!-- <button id="btnSetNormalidadAlc" class="btn-success"><i class="fas fa-save"></i> Crear</button> -->
                <button id="btnSetNormalidadAci" class="btn-info"><i class="fas fa-square-root-alt"></i>
                  Ejecutar</button>
...
<div class="modal fade" id="modalCapturaSolidosDir" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="">Captura de resultados Solidos (Diferencia) - Folio de muestra: <input type="text"
            id="folioSolidosDir" style="border: none; color:red;" disabled></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div class="modal fade" id="modalCapturaSolidos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="">Captura de resultados Solidos | # Muestra: <input type="text"
            id="muestraCapturaSolidos" style="width: 200px;border: none"></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="col-md-3">
                ...
                <input type="text" id="crisolSolidos" style="font-size: 20px;color:blue;"
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="">
          <div id="tituloModalAlcalinidad">Captura de resultados Alcalinida</div>
        </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
            ...
            <table class="table" id="">
              ...
              <tbody>
                ...
                <tr>
                  <td>B</td>
                  <td>
                    <div id="tituloNormalidadModal">Normalidad aido sulfúrico</div>
                  </td>
            ...
            <table class="table" id="">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="text" id="resFeno" ></td>
                  <td>F</td>
                </tr>
                <tr>
                  <td>B</td>
                  <td>Alc. A la Anaranjado</td>
                  <td><input type="text" id="resAnaranjado" ></td>
                  <td>F</td>
                </tr>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="form-group">
              ...
              <input type="text" id="resultadoDirectoTur2" style="font-size: 20px;color:rgb(0, 26, 255);"
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="form-group">
              ...
              <input type="text" id="resultadoDirectoColor2" style="font-size: 20px;color:blue;"
                placeholder="Resultado2">
            </div>
          </div>
...
<div class="modal fade" id="modalCapturaEnt" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <td>
    ...
    <table>
      <tr>
        <td><input type="text" id="enPre1Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre2Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre3Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enPre4Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre5Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre6Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enPre7Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre8Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre9Ent" style="width: 50px;"></td>
      </tr>
    </table>
  </td>
  <td>
    <center>48 Hrs</center>
    <table>
      <tr>
        <td><input type="text" id="enPre12Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre22Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre32Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enPre42Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre52Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre62Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enPre72Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre82Ent" style="width: 50px;"></td>
        <td><input type="text" id="enPre92Ent" style="width: 50px;"></td>
      </tr>
    </table>
  </td>
  <td>V</td>
...
<tr>
  ...
  <td>
    ...
    <table>
      <tr>
        <td><input type="text" id="enCon1Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon2Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon3Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enCon4Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon5Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon6Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enCon7Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon8Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon9Ent" style="width: 50px;"></td>
      </tr>
    </table>
  </td>
  <td>
    ...
    <table>
      <tr>
        <td><input type="text" id="enCon12Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon22Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon32Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enCon42Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon52Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon62Ent" style="width: 50px;"></td>
      </tr>
      <tr>
        <td><input type="text" id="enCon72Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon82Ent" style="width: 50px;"></td>
        <td><input type="text" id="enCon92Ent" style="width: 50px;"></td>
      </tr>
    </table>
  </td>
<td>V</td>
...
<!-- Inicio Color -->
<div class="modal fade" id="modalCapturaColorVerdadero" tabindex="-1" aria-labelledby="exampleModalLabel"
  aria-hidden="true">
  <div class="modal-dialog modal-lg" style="width: 80%">
    <div class="modal-content">
      <div class="modal-header">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="observacionColorDir1"
                    placeholder="Observacion de la muestra 1">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="observacionColorDir2">Observacion 525</label>
                  <input type="text" class="form-control" id="observacionColorDir2"
                    placeholder="Observacion de la muestra 2">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="observacionColorDir3">Observacion 620</label>
                  <input type="text" class="form-control" id="observacionColorDir3"
                    placeholder="Observacion de la muestra 3">
                </div>
              </div>
            </div>
            <div class="form-group">
              <button class="btn btn-success" type="button"
                onclick="setObservacion('observacionColorDir1','observacionColorDir2','observacionColorDir3')"><i
                  class="voyager-check"></i> Aplicar</button>
            </div>
          </div>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="">Observación</label>
              <input type="text" class="form-control" id="observacionVidrio" placeholder="Observacion de la muestra">
            </div>
            <div class="form-group">
          ...
          <div class="col-md-8">
            <div class="form-group">
              <label for="resultadoVidrio1">Res1</label><input type="text" id="resultadoVidrio1"
                style="font-size: 10px;color:red;" placeholder="Resultado">
              <label for="resultadoVidrio2">Res2</label><input type="text" id="resultadoVidrio2"
                style="font-size: 10px;color:red;" placeholder="Resultado">
              <label for="resultadoVidrio3">Res3</label><input type="text" id="resultadoVidrio3"
                style="font-size: 10px;color:red;" placeholder="Resultado"><br>
              <label for="resultadoVidrio4">Res4</label><input type="text" id="resultadoVidrio4"
                style="font-size: 10px;color:red;" placeholder="Resultado">
              <label for="resultadoVidrio5">Res5</label><input type="text" id="resultadoVidrio5"
                style="font-size: 10px;color:red;" placeholder="Resultado">
              <label for="resultadoVidrio6">Res6</label><input type="text" id="resultadoVidrio6"
                style="font-size: 10px;color:red;" placeholder="Resultado">
            </div>
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="porcentajeE">
              <label class="form-check-label" for="porcentajeE">Porcentaje E</label>
            </div>
          </div>
...
@section('javascript')
<script src="{{asset('/public/js/laboratorio/analisis/captura.js')}}?v=1.5.1"></script>

<script src="{{asset('/assets/summer/summernote.js')}}"></script>
<link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-bs4.min.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-bs4.min.js"></script>
@stop@extends('voyager::master')
@section('content')
<link rel="stylesheet" href="{{asset('/public/assets/summer/summernote.min.css')}}">
<link rel="stylesheet" href="{{asset('/public/css/laboratorio/analisis/captura.css')}}">
...
@section('javascript')
<script src="{{asset('/public/js/laboratorio/analisis/captura.jsx')}}?v=1.5.1"></script>
...
@section('javascript')
<script src="{{asset('/public/js/laboratorio/analisis/captura.jsx')}}?v=3.0.0"></script>
