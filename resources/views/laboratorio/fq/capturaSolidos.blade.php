            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <button class="btn btn-success" type="button" onclick="updateObsMuestraSolidos('observacion')"
                      id="btnAplicarObs">Aplicar</button>
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" id="resultado" style="font-size: 20px;color:red;" placeholder="Resultado">
                  </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="modal-body">
              <div class="row">
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <button class="btn btn-success" type="button" onclick="updateObsMuestraSolidosDif()"
                      id="btnAplicarObs">Aplicar</button>
                  </div>
                  <div class="dropdown-divider"></div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="resultado">Resultado</label>
                    <input type="text" id="resultadoDif" style="font-size: 20px;color:red;" placeholder="Resultado">
                  </div>
                </div>
                <div class="col-md-6">
