            ...
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <h6>Cliente: <strong>{{@$model->Sucursal}}</strong></h6>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            <div class="form-check">
                                ...
                                <input class="form-check-input" id="ckSupervisado" type="checkbox" value=""
                                    id="defaultCheck1" @if (@$proceso->Supervicion == 1) checked = "true" @endif>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label" for="defaultCheck1">Liberado</label>
                                <input class="form-check-input" id="ckLiberado" type="checkbox" value=""
                                    id="defaultCheck1" @if (@$proceso->Liberado == 1) checked = "true" @endif>
                            </div>
                            <div class="form-check">
                                <label class="form-check-label" for="defaultCheck1">Historial</label>
                                <input class="form-check-input" id="ckHistorial" type="checkbox" value=""
                                    id="defaultCheck1" @if (@$proceso->Historial_resultado == 1) checked = "true"
                                @endif>
                            </div>
            ...
            <div class="card" style="width: 100%;">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button id="btnLiberar" class="btn-success"><i class="fas fa-square-root-alt"
                                    data-toggle="tooltip" data-placement="top" title="Liberar"></i></button>
                            ...
                            <button id="btnDesactivar" class="btn-danger" onclick="desactivarMuestra()"
                                data-toggle="tooltip" data-placement="top" title="Ocultar"><i
                            ...
                            <table>
                                <tr>
                                    <td>Resultado</td>
                                    <td><input type="text" style="font-size: 20px;width: 100px;color:red;" id="resDes"
                                            value="0.0"></td>
                                </tr>
                            </table>
                        </div>
