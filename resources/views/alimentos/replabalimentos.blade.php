...
<div class="container-fluid">
    <div class="row justify-content-center align-items-center" style="height: 100vh;">
        <!-- Contenedor para las dos tarjetas principales -->
        <div class="row w-100">
                            ...
                            <div class="tab-pane fade" id="desecho" role="tabpanel" aria-labelledby="desecho-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="analistadesecho" id="analistadesecho" class="form-control" required>
                                        <option value="" disabled selected>Sin seleccionar</option>
                                        <option value="SAUL LUCERO GARCIA" selected>SAUL LUCERO GARCIA</option>
                                        <option value="DOLORES MARIELA ANDRADE JAIMES" selected>DOLORES MARIELA ANDRADE
                                            JAIMES</option>
                                        <option value="GUADALUPE GARCIA PÉREZ" selected>GUADALUPE GARCIA PÉREZ</option>
                                    </select>
                                </div>
                                <div class="form-group">
            ...
            <!-- Tarjeta para los registros -->
            <div class="col-md-6">
                <div class="card shadow-lg">
                    <div class="card-header bg-success text-white text-center">
                        <h2>Recepción Laboratorio</h2>
                    </div>
                    <div class="card-body">
