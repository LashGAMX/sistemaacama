                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="contacto" id="contacto" class="form-control select2"
                                onchange="getDataContacto(this.value)">
                                <option value="0">Sin seleccionar</option>
                            </select>

                            <small id="" class="form-text text-muted">
                                <code>Deshabilitado temporalmente (Crear/editar)</code><br>
                                <button id="BtnCrear" style="border:none;background:none;"
                                    type="button"><i class="fa fa-user-plus text-success hover"> Nuevo
                                        contacto</i></button>
                                <button  id="BtnEditar" style="border:none;background:none;"
                                    type="button"><i class="fa fa-user-edit text-warning"> Editar</i></button>
                            </small>
                        </div>
                    </div>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="contactoModalLabel">Detalles del Contacto</h5>
                                ...
                                <div class="modal-body">
                                    <table class="table">
                                        <tr>
                                            <td>Nombre: </td>
                                            <td><input type="text" class="form-control" id="nombre" required ></td>
                                        </tr>
                                        <tr>
                                            <td>Departamento: </td>
                                            <td><input type="text" class="form-control" id="dept" required></td>
                                            <td>Puesto/Cargo: </td>
                                            <td><input type="text" class="form-control" id="puesto"  required></td>
                                        </tr>
                                        <tr>
                                            <td>Email: </td>
                                        ...
                                        <tr>
                                            <td>Celular: </td>
                                            <td><input type="text" class="form-control" id="cel" required></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                    </table>
                                ...
                                <button type="button" class="btn btn-success" id="GuardarContacto" >Guardar</button>
                                <button type="button" class="btn btn-warning" id="EditarContacto" >Guardar Cambios</button>
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="norma" id="norma" class="form-control select2"
                            onchange="getSubNormas(this.value)">
                            <option value="0">Sin seleccionar</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="subnorma" id="subnorma" class="form-control"
                            onchange="getParametrosNorma(this.value)">
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="fechaMuestreo">Fecha muestreo</label>
                        <input type="date" id="fechaMuestreo" name="fechaMuestreo" @if (@$model->Folio_servicio != "")
                        disabled @endif
