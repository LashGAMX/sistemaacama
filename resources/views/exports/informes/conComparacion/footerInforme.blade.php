...
<div id="contenedorTabla">
    <table autosize="1" class="table table-borderless paddingTop" id="tablaDatos" cellpadding="0" cellspacing="0" border-color="#000000" width="100%">
        <tbody>            
                <tr>
                    <td class="nombreHeader nom fontSize11 justificadorIzq" height="57">{{@$solicitud->Observacion}}{{-- OBSERVACIONES: TEMPERATURA AMBIENTE PROMEDIO DE 25.97°C, LA MUESTRA PRESENTA OLOR Y COLOR TURBIO <br>
