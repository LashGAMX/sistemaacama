<footer>
    <div class="contenedorPadre12">
        <div class="contenedorHijo12">            
            ...
            @else
                <span><img style="width: auto; height: auto; max-width: 100px; max-height: 70px;" src="http://sistemasofia.ddns.net:85/sofia/public/storage/{{@$analizo->firma}}"> <br></span>
        ...
        <div class="contenedorHijo12">
            ...
            <span><img style="width: auto; height: auto; max-width: 100px; max-height: 70px;" src="http://sistemasofia.ddns.net:85/sofia/public/storage/{{@$reviso->firma}}"> <br></span>
