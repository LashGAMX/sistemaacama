...
<div style="width: 100%">
        <table autosize="1" class="table table-borderless" id="tablaDatos" cellpadding="0" cellspacing="0"
            ...
            <tbody>
                ...
                <tr>
                    <td class="filasIzq bordesTabla anchoColumna7 bordeDerSinSup" rowspan="6" style="font-size: 10px">
                    ...
                    <td class="filasIzq bordesTabla bordeConIzqFinalSup anchoColumna28 paddingTopBotInter">Fecha de
                        Muestreo: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="fontBold"> {{ \Carbon\Carbon::parse(@$datos->Fecha_muestreo)->format('d/m/Y')
                            }}</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="filasIzq bordesTabla bordeSinIzqFinalSup anchoColumna28 fontBold" colspan="2"
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <span class="fontBold"> @if (@$datos->Siralab == 1)
            ...
            <tbody>
                <tr>
                    <td class="nombreHeader fontBold nom justificadorCentr" style="font-size: 8px;">
                        ...
                        COMPUESTA
                        @endif
                        QUE ESTABLECE LOS LIMITES PERMISIBLES DE CONTAMINANTES EN LAS DESCARGAS DE AGUAS RESIDUALES EN
...
<div id="contenedorTabla">
 <table autosize="1" class="table table-borderless" id="tablaDatos" cellpadding="0" cellspacing="0"
     ...
     <thead>
         <tr>
             <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" height="30"
                 width="20.6%">PARAMETRO &nbsp;</td>
             <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="20.6%">
                 &nbsp;METODO DE PRUEBA&nbsp;&nbsp;
             </td>
      ...
      <tbody>
                ...
                <tr>
                    ...
                    @endif
                     @if ($incerAux >0)
                          <td class="tableContent bordesTablaBody" style="font-size: 8px;"> {{$item->Incertidumbre}}</td>
                    @endif
                    <td class="tableContent bordesTablaBody" style="font-size: 8px;">
                        @if (@$item->Resultado2 != NULL)
                        {{@$item->AnalizoInicial}}
                ...
                @case(372)
                @php
                $parametro=DB::table('lote_detalle_directos')->where('Id_codigo',$item->Id_codigo)->where('Id_control',1)->first(); $cod = DB::table('codigo_parametro')->where('Id_codigo',$item->Id_codigo)->first();
                @endphp
                <tr>
                  <td class="tableContent bordesTablaBody" style="font-size: 8px;" height="25">
                ...
                <tr>
                    <td class="tableContent bordesTablaBody" style="font-size: 8px;" height="25">
                        {{@$item->Parametro}}<sup>{{$item->Simbologia}}</sup> <br> Coeficiente de absorción <br>
                        espectral 436 nm
                    </td>
                    <td class="tableContent bordesTablaBody" style="font-size: 8px;">
                        {{$item->Metodo}}
...
@if ($datos2->contains('Id_parametro', 173))
    ...
    <div id="contenedorTabla" >
        <table autosize="1" class="table table-borderless" id="tablaDatos" cellpadding="0" cellspacing="0"
            ...
            <thead>
                <tr>
                    <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="10.6%">PARAMETRO &nbsp;</td>
                    <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="10.6%"># DE TOMA &nbsp;</td>
                    <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="20.6%">
                        &nbsp;METODO DE PRUEBA&nbsp;&nbsp;</td>
                    <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="10.6%">
                        &nbsp;UNIDAD&nbsp;&nbsp;</td>
                    <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="10.6%"
                        colspan="2">&nbsp;CONCENTRACION <br> CUANTIFICADA&nbsp;&nbsp;</td>
                    <td style="font-size: 8px;" class="tableCabecera bordesTablaBody justificadoCentr" width="10.6%">
                        ANALISTA</td>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    <td class="tableContent bordesTablaBody" style="font-size: 11px;" height="25" rowspan="6">Toxicidad
                        aguda ( <i>Vibrio fischeri</i> ) <sup>{{$item->Simbologia}} </sup></td>
                    <td class="tableContent bordesTablaBody" style="font-size: 11px;" height="25" rowspan="6">
                        {{$item->Num_muestra}}</td>
                ...
                <tr>
                    <td class="tableContent bordesTablaBody" style="font-size: 11px;" rowspan="3">@if ($item->Ph_muestra
                        == "1")
                        %E
                        @else
                        {{@$item->Unidad}}
...
<footer>
                ...
                <tbody>
                    <tr>
                       <td class="nombreHeader nom fontSize11 justificadorIzq" style="font-size: 8px;margin:2px">
                            ...
                            @if ($datos3->Fecha_muestreo < '2025-03-21' ) {{-- Solo mostrar esto si la fecha es anterior a 21 marzo 2025 --}}
                            ...
                            @break
                                ...
                                @if ($datos->Id_servicio != 3)
                                OBSERVACIONES: TEMPERATURA AMBIENTE PROMEDIO DE {{@$tempAmbienteProm}}°C,
                                @php if(@$datos3->Olor == true) {echo "LA MUESTRA PRESENTA OLOR";} else{ echo "LA MUESTRA
                                NO
                                PRESENTA OLOR";}@endphp
                                Y COLOR DE LA MUESTRA {{$datos3->Color}} ,
                                EL MUESTREO FUE REALIZADO DE ACUERDO A LO ESTABLECIDO EN EL PROCEDIMIENTO

                                @if ($datos3->Proce_muestreo)
                                PE-10-002-{{str_pad($datos3->Proce_muestreo, 2, "0", STR_PAD_LEFT)}} <br>
                                @endif
                                ...
                                <p> OBSERVACIONES: MUESTRA REMITIDA AL LABORATORIO POR EL CLIENTE, LOS RESULTADOS SE
                                    ...
                                    @if (@$datos3->Obs_proceso != NULL ||
                                    @$datos3->Obs_proceso != "" || @$datos3->Obs_proceso !=
                                    "NULL")
                                    {{$datos3->Obs_proceso}}
                                     {{ @$datos3->Observaciones }}
                                    @endif</p>
                ...
                <tbody>
                    <tr>
                        <td class="nombreHeaders fontBold justificadorIzq" style="font-size: 5.9px; width: 80%;">
                            ...
                            <br>
                            @if ($tipo == 1)
                            A SOLICITUD DEL CLIENTE SE COMPARA EL INFORME DE RESULTADOS CON LOS LIMITES PERMISIBLES DE
                            LA NORMA
                            @endif
                        ...
                        <td style="width: 15%">
                            @php
                            $url =
                            "http://sistemasofia.ddns.net:86/sofia/clientes/informe-de-resultados-acama/".@$folioEncript;
                            $qr_code = "data:image/png;base64," . \DNS2D::getBarcodePNG((string) $url, "QRCODE");
                            @endphp

                            <center><img style="width: 8%; height: 8%;" src="{{@$qr_code}}" alt="qrcode" /> <br> <span
                                    class="fontSize9 fontBold">&nbsp;&nbsp;&nbsp; {{@$datos->Folio_servicio}}</span>
                            </center>
                        </td>
                    </tr>
                </tbody>
        ...
        <div id="contenedorTabla">
            ...
            <tbody>
                ...
                @foreach ($datos2 as $item)
                    @php
                        $num = @$numTomas && $numTomas->count() ? $numTomas->count() : $datos->Num_tomas;
                    @endphp
                    ...
                    @switch($item->Id_simbologia)
                        ...
                        @case(11)
                            <tr>
                                <td style="font-size: 5.9px" class="fontBold justificadorIzq">
                                    1++ MEDIA GEOMETRICA DE LAS {{ $num }} MUESTRAS SIMPLES DE ESCHERICHIA COLI.
                                </td>
                            </tr>
                            @break
                        ...
                        @case(5)
                            <tr>
                                <td style="font-size: 5.9px" class="fontBold justificadorIzq">
                                    1# PROMEDIO PONDERADO DE LAS {{ $num }} MUESTRAS SIMPLES DE GRASAS Y ACEITES
                                </td>
                            </tr>
                            @break
                        ...
                        @case(4)
                            <tr>
                                <td style="font-size: 5.9px" class="fontBold justificadorIzq">
                                    ...
                                    EL VALOR MINIMO CUANTIFICADO REPORTADO SERA DE 3, COMO CRITERIO CALCULADO PARA COLIFORMES EN SIRALAB Y EL LABORATORIO.
                                </td>
                            </tr>
                            @break
                        ...
                        @case(12)
                            <tr>
                                <td style="font-size: 5.9px" class="fontBold justificadorIzq">
                                    1+++ MEDIA GEOMETRICA DE LAS {{ $num }} MUESTRAS SIMPLES DE ENTEROCOCOS FECALES.
                                </td>
                            </tr>
                            @break
                    ...
                    <table autosize="1" class="table table-borderless paddingTop" id="tablaDatos" cellpadding="0"
                        ...
                        <tbody>
                            ...
                            @for ($i = 0; $i < sizeof($temp); $i++) @if ($temp[$i]==$item->Id_simbologia_info)
                                ...
                                @if ($auxTemp != "")
                                <tr>
                                    <td style="font-size: 5.9px" class="fontBold justificadorIzq"> {{$auxTemp}} RESULTADO DE LA
                                        MUESTRA SIMPLE. </td>
                                </tr>
                                @endif
                        </tbody>
