    ...
    <div class="row">
        ...
        <div class="col-md-12">
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade active" id="datosGenerales" role="tabpanel" aria-labelledby="datosGenerales-tab">  
              <form>
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <select name="" id="" class="form-control">
                    <option>MEDIDOR DE PH TEMEPRATURA Y CONDUCTIVIDAD</option>
                  </select>
                </div>
              </div>
              <div class="col-md-4">
              ...
              <div class="col-md-12">
                ...
                <table class="table" id="factorDeConversion">
                  <thead>
                    <tr>
                      <th>De °C</th>
                      <th>a °C</th>
