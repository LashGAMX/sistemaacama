                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <small id="" class="form-text text-muted">
                          ...
                          <button onclick="setContacto()" style="border:none;background:none;"><i class="fa fa-user-edit text-warning"> Editar</i></button>
                        </small>
                      </div>
                    </div>
                    <div class="col-md-8">
            ...
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" id="numTomas" class="form-control">
                </div>
