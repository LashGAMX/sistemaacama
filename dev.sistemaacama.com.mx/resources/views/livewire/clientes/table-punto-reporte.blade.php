  ...
  @endif
    <table class="table table-hover">
      ...
      @endif
          ...
          <td>
            <button type="button" class="btn btn-primary" wire:click="setData('{{$item->Id_punto}}','{{$item->Punto_muestreo}}')"  data-toggle="modal" data-target="#modalPuntoReporte"><i class="voyager-edit"></i> <span hidden-sm hidden-xs>editar</span> </button>
          </td>
          {{-- </form>  --}}
        </tr>
    @endforeach 
    ...
    <div wire:ignore.self class="modal fade" id="modalPuntoReporte" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form wire:submit.prevent="store">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Modificar punto muestreo</h5>
