...
function valTempMuestraAmbiente(lec1, lec2, lec3, prom1 ,prom2) {
...
function setDataMuestreo() { 
    ...
    for (let i = 0; i < $("#numTomas").val(); i++) {
        row = new Array();
        row.push($("#tempa1" + i).val());
        row.push($("#temp2" + i).val());
        row.push($("#temp3" + i).val());
        row.push($("#temppromAmb" + i).val());
        row.push($("#tempStatus1" + (i+1)).val());
        temperaturaAmbiente.push(row);
    }
    ...
    $.ajax({
        ...
        data: {
            ...
            temperatura2:temperaturaAmbiente,
            phCalidad: phCalidad,
...
function cancelaMuestra(){
    ...
    if(resultado === true){        
        ...
        if(valor == 0){
            ...
            //Temperatura Ambiente
            $("#tempa10").attr("disabled", true).val(null);
            $("#tempa20").attr("disabled", true).val(null);
            $("#tempa30").attr("disabled", true).val(null);
            $("#tempaStatus11").val(0);
            ...
            //Temperatura Ambiente
            $("#tempa11").attr("disabled", true).val(null);
            $("#tempa21").attr("disabled", true).val(null);
            $("#tempa31").attr("disabled", true).val(null);
            $("#tempaStatus12").val(0);
            ...
            //Temperatura Ambiente
            $("#tempa12").attr("disabled", true).val(null);
            $("#tempa22").attr("disabled", true).val(null);
            $("#tempa32").attr("disabled", true).val(null);
            $("#tempaStatus13").val(0);
            ...
            //Temperatura Ambiente
            $("#tempa13").attr("disabled", true).val(null);
            $("#tempa23").attr("disabled", true).val(null);
            $("#tempa33").attr("disabled", true).val(null);
            $("#tempaStatus14").val(0);
            ...
            //Temperatura Ambiente
            $("#tempa14").attr("disabled", true).val(null);
            $("#tempa24").attr("disabled", true).val(null);
            $("#tempa34").attr("disabled", true).val(null);
            $("#tempaStatus15").val(0);
            ...
            //Temperatura Ambiente
            $("#tempa15").attr("disabled", true).val(null);
            $("#tempa25").attr("disabled", true).val(null);
            $("#tempa35").attr("disabled", true).val(null);
            $("#tempaStatus16").val(0);
