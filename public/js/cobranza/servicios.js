    ...
    $.ajax({
        ...
        success: function (response) {
          ...
          if (parseInt(response.sw) == 0) {
            $('#tablaServicio tbody tr.selected').css('background-color', '#ffffff');
          }else{
            $('#tablaServicio tbody tr.selected').css('background-color', '#dff0d8');
          }
           alert(response.msg)
        }
    });
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (parseInt(response.sw) == 0) {
          ...
          $('#tablaServicio tbody tr.selected').css('background-color', '#fbf18a');
        }
         alert(response.msg)
      }
  });
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        if (parseInt(response.sw) == 0) {
          ...
          $('#tablaServicio tbody tr.selected').css('background-color', '#fdaaa3');
        }
         alert(response.msg)
      }
  });
