...
var setObservacion = function (id = "", id2 = "na", id3 = "na") {
    $.ajax({
        type: "POST",
        url: base_url + "/admin/alimentos/setObservacion",
        data: {
            idLote: idLote,
            idMuestra: idMuestra,
            observacion: $("#" + id).val(),
...
function setLiberar() {
    $.ajax({
        type: "POST",
        url: base_url + "/admin/alimentos/setLiberar",
        data: {
            idMuestra: idMuestra,
            idLote: idLote,
            _token: $('input[name="_token"]').val(),
        ...
        case 5:
            switch (parseInt($("#parametro").val())) {
                case 152: // COT
                    $.ajax({
                        type: "POST",
                        url: base_url + "/admin/alimentos/setDetalleMuestra",
                        data: {
                            idLote: idLote,
                            idMuestra: idMuestra,
                            ABS: $("#abs1COT").val(),
                ...
                case 161:
                    if (idTecnica == 2) {
                        $.ajax({
                            type: "POST",
                            url:
                                base_url + "/admin/alimentos/setDetalleMuestra",
...
function getCapturaLote() {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "/admin/alimentos/getCapturaLote",
        data: {
            idLote: idLote,
            _token: $('input[name="_token"]').val(),
        },
...
function setMuestraLote() {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "/admin/alimentos/setMuestraLote",
        data: {
            codigos: codigos,
            idLote: idLote,
            _token: $('input[name="_token"]').val(),
...
function getMuestraSinAsignar() {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "/admin/alimentos/getMuestraSinAsignar",
        data: {
            idLote: idLote,
            idParametro: $("#parametro").val(),
