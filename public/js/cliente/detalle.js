    ...
    $.ajax({
        ...
        success: function (response) {            
            ...
            $.each(response.model, function (key, item) {
                ...
                tab += '<td><button class="btn btn-info" onclick="getContactoGeneral('+item.Id_contacto+')" data-toggle="modal" data-target="#modalGenerales"><i class="fas fa-edit"></i></button></td>';
                tab += '</tr>';
            }); 
            tab += '    </tbody>';
            tab += '</table>';
