    ...
    switch (parseInt(idArea)) {
        ...
        case 8:
            ...
            switch (parseInt($("#parametro").val())) {
                ...
                case 119:
                case 218:
                    document.getElementById("divTitulo1Cloros").innerHTML =
                        "mL Titulado 1 de Tiosulfato";
                    document.getElementById(
                        "divTituloTrazableCloros"
                    ).innerHTML = "mL de K2Cr2O7 Trazable";
                    $("#secctionCloro").show();
                    break;
                case 64:
                    document.getElementById("divTitulo1Cloros").innerHTML =
                    ...
                    document.getElementById(
                        "divTituloTrazableCloros"
                    ).innerHTML = "mL de Cloruro de sodio";
                    $("#secctionCloro").show();
                    break;
                case 6: // DQO
                case 161:
...
function setFormulaValoracion() {
    ...
    switch (parseFloat($("#parametro").val())) {
        ...
        case 119:
            ...
            prom =
                (parseFloat(titulado1) +
                    parseFloat(titulado2) +
                    parseFloat(titulado3)) /
                3;
        ...
        case 29: // Alcalinidad
            ...
            fac = $("#factorAlc").val();
            promB =
                (parseFloat(vol1) + parseFloat(vol2) + parseFloat(vol3)) / 3;
            prom =
                (parseFloat(titulado1) +
                    parseFloat(titulado2) +
                    parseFloat(titulado3)) /
        ...
        case 251:
            ...
            res =
                solucion /
                (prom.toFixed(4) - parseFloat($("#blancoResDur").val()));
        ...
        case 103:
            ...
            let promBlanco = 0;
            promBlanco =
                (parseFloat($("#blancoDureza").val()) +
                    parseFloat($("#blancoDureza2").val()) +
                    parseFloat($("#blancoDureza3").val())) /
                3;
            $("#blancoResDur").val(promBlanco);
            solucion1 = parseFloat($("#tituladoDurSec1").val());
            prom1 =
                (parseFloat($("#edtaDur1Sec1").val()) +
                    parseFloat($("#edtaDur2Sec1").val()) +
                    parseFloat($("#edtaDur3Sec1").val())) /
                3;
            res1 =
                solucion1 /
                (prom1.toFixed(4) - parseFloat($("#blancoResDur").val()));

            solucion2 = parseFloat($("#tituladoDurSec2").val());
            prom2 =
                (parseFloat($("#edtaDur1Sec2").val()) +
                    parseFloat($("#edtaDur2Sec2").val()) +
                    parseFloat($("#edtaDur3Sec2").val())) /
                3;
            res2 =
                solucion2 /
                (prom2.toFixed(4) - parseFloat($("#blancoResDur").val()));

            solucion3 = parseFloat($("#tituladoDurSec3").val());
            prom3 =
                (parseFloat($("#edtaDur1Sec3").val()) +
                    parseFloat($("#edtaDur2Sec3").val()) +
                    parseFloat($("#edtaDur3Sec3").val())) /
                3;
            res3 =
                solucion3 /
                (prom3.toFixed(4) - parseFloat($("#blancoResDur").val()));
...
function exportBitacora(id) {
    window.open(
        base_url + "/admin/laboratorio/" + area + "/bitacora/impresion/" + id
    );
}
        ...
        success: function (response) {
            ...
            switch (parseInt(idArea)) {
                    ...
                    switch (parseInt($("#parametro").val())) {
                        ...
                        case 29:
                            if (response.model != null) {
                                $("#idNormalidadAlc").val(
                                    response.model.Id_valoracion
                                );
                                $("#resValAlc").val(response.model.Resultado);
                                $("#fecIniAlc").val(
                                    response.model.Fecha_inicio
                                );
                                $("#fecFinAlc").val(response.model.Fecha_fin);
                                $("#granoCarbon1").val(
                                    response.model.Granos_carbon1
                                );
                                $("#granoCarbon2").val(
                                    response.model.Granos_carbon2
                                );
                                $("#granoCarbon3").val(
                                    response.model.Granos_carbon3
                                );
                                $("#tituladodeH1").val(
                                    response.model.Titulado1
                                );
                                $("#tituladodeH2").val(
                                    response.model.Titulado2
                                );
                                $("#tituladodeH3").val(
                                    response.model.Titulado3
                                );
                                $("#equivalenteAlc").val(
                                    response.model.Granos_equivalente
                                );
                                $("#factConversionAlc").val(
                                    response.model.Factor_conversion
                                );

                                tab +=
                                    '<h6>Historial</h6><table id="tabCaptura" class="table table-sm">';
                                tab += "    <thead>";
                                tab += "        <tr>";
                                tab += "          <th>ID</th>";
                                tab += "          <th>Fecha Ini</th>";
                ...
                case 8:
                    switch (parseInt($("#parametro").val())) {
                        ...
                        case 252:
                            if (response.model != null) {
                                $("#tituladoDurSec1").val(
                                    response.model.SolucionSec1
                                );
                                $("#edtaDur1Sec1").val(
                                    response.model.Disolucion1Sec1
                                );
                                $("#edtaDur2Sec1").val(
                                    response.model.Disolucion2Sec1
                                );
                                $("#edtaDur3Sec1").val(
                                    response.model.Disolucion3Sec1
                                );
                                $("#resDurezaSec1").val(
                                    response.model.ResultadoSec1
                                );

                                $("#tituladoDurSec2").val(
                                    response.model.SolucionSec2
                                );
                                $("#edtaDur1Sec2").val(
                                    response.model.Disolucion1Sec2
                                );
                                $("#edtaDur2Sec2").val(
                                    response.model.Disolucion2Sec2
                                );
                                $("#edtaDur3Sec2").val(
                                    response.model.Disolucion3Sec2
                                );
                                $("#resDurezaSec2").val(
                                    response.model.ResultadoSec2
                                );

                                $("#tituladoDurSec3").val(
                                    response.model.SolucionSec3
                                );
                                $("#edtaDur1Sec3").val(
                                    response.model.Disolucion1Sec3
                                );
                                $("#edtaDur2Sec3").val(
                                    response.model.Disolucion2Sec3
                                );
                                $("#edtaDur3Sec3").val(
                                    response.model.Disolucion3Sec3
                                );
                                $("#resDurezaSec3").val(
                                    response.model.ResultadoSec3
                                );
                ...
                case 13: //G&A
                    ...
                    $("#5entradaGA").val(
                        response.model.Enfriado_matraces_entrada
                    );
                    $("#5salidaGA").val(
                        response.model.Enfriado_matraces_salida
                    );
                    break;
                case 6:
                case 12:
            ...
            $("#tituloLote").val(
                id + " - " + parametro + "| Fecha lote:" + response.lote.Fecha
            );
            ...
            switch (parseInt($("#parametro").val())) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response.idControl == 5) {
                                ...
                                $("#abs1COT").val(
                                    parseFloat(response.model.Promedio).toFixed(
                                        3
                                    )
                                );
                                $("#abs2COT").val(
                                ...
                                $("#resultadoCOT").val(
                                    response.model.Resultado.toFixed(3)
                                );
                                $("#fDilucion1COT").val(
                                    response.model.Vol_dilucion.toFixed(3)
                                );
                                $("#fDilucion2COT").val(
                                    response.model.Vol_dilucion.toFixed(3)
                                );
                ...
                case 113:
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log(response);
                            $("#abs1SulfatosF").val(
                                response.model.Promedio.toFixed(3)
                            );
                            $("#abs2SulfatosF").val(
                                response.model.Promedio.toFixed(3)
                            );
                            $("#resultadoSulfatos").val(
                                response.model.Resultado.toFixed(3)
                            );
                            $("#fDilucion1SulfatosF").val(
                                response.model.Vol_dilucion.toFixed(3)
                            );
                            $("#fDilucion2SulfatosF").val(
                                response.model.Vol_dilucion.toFixed(3)
                            );
                        },
                    });
                ...
                default:
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log(response);
                            $("#absPromEspectro1").val(
                                parseFloat(response.model.Promedio.toFixed(3))
                            );
                            $("#absPromEspectro2").val(
                                parseFloat(response.model.Promedio.toFixed(3))
                            );
                            $("#resultadoEspectro").val(
                                parseFloat(response.model.Resultado.toFixed(3))
                            );
                            $("#fDilucionEspectro1").val(
                                parseFloat(response.model.Vol_dilucion).toFixed(
                                    3
                                )
                            );
                            $("#fDilucionEspectro2").val(
                                parseFloat(response.model.Vol_dilucion).toFixed(
                                    3
                                )
                            );
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.std == true) {
                        let fixh1 = parseFloat(response.model.M_final).toFixed(
                            4
                        );
                        let fixj1 = parseFloat(
                            response.model.M_inicial1
                        ).toFixed(4);
                        let fixk1 = parseFloat(
                            response.model.M_inicial2
                        ).toFixed(4);
                        let fixc1 = parseFloat(
                            response.model.M_inicial3
                        ).toFixed(4);
                ...
                case 3: // Directos
                    $.ajax({
                        ...
                        data: {
                            ...
                            temperaturaLlegada: $(
                                "#temperaturaLlegadaSolidosDir"
                            ).val(),
                            temperaturaAnalizada: $(
                                "#temperaturaAnalizadaSolidosDir"
                            ).val(),
                    ...
                    if (idTecnica == 2) {
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                $("#resultadoDqoVol").val(
                                    number_format(
                                        response.model.Resultado.toFixed(2),
                                        2,
                                        ".",
                                        ""
                                    )
            ...
            switch (parseInt($("#parametro").val())) {
                ...
                case 119:
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log(response);
                            alert("datos guardados");
                            $("#dilucionCloro1DirectoClo").val(
                                response.model.Factor_dilucion
                            );
                            $("#promedioCloro1DirectoClo").val(
                                response.model.Resultado
                            );
                            $("#resultadoDirectoClo").val(
                                response.model.Resultado
                            );
                        },
                    });
                ...
                case 370:
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log(response);
                            $("#resultadoDirectoColor").val(
                                response.model.Resultado
                            );
                            // $("#dilusion1DirectoColor").val(response.mode)
                            $("#factor1DirectoColor").val(
                                response.Factor_dilucion
                            );
                        },
                    });
                    break;
                ...
                case 115:
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log(response);
                            $("#promedioTurb1DirectoTur").val(
                                response.model.Promedio
                            );
                            $("#resultadoDirectoTur").val(
                                number_format(
                                    parseFloat(response.model.Resultado),
                                    3,
                                    ".",
                                    ""
                                )
                            );
                            $("#dilusionTurb1DirectoTur").val(
                                response.model.Factor_dilucion
                            );
                        },
                    });
            ...
            switch (parseInt($("#parametro").val())) {
                ...
                case 251:
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $("#resInd1Dureza").val(
                                response.model.ResultadoVal1
                            );
                            $("#resInd2Dureza").val(
                                response.model.ResultadoVal2
                            );
                            $("#resInd3Dureza").val(
                                response.model.ResultadoVal3
                            );
                ...
                default:
                    $.ajax({
                        ...
                        success: function (response) {
                            console.log(response);
                            $("#resultadoPotable").val(
                                response.resultado.toFixed(2)
                            );
                        },
                    });
                    break;
            ...
            switch (parseInt($("#parametro").val())) {
                ...
                case 134:
                    ...
                    if (presuntiva2 < presuntiva1) {
                        alert(
                            "La presuntiva de 24hrs no puede ser mayor a la Presuntiva de 48hrs"
                        );
                    } else if (confir2 < confir1) {
                        alert(
                            "La confirmativas de 24hrs no puede ser mayor a la Confirmativa de 48hrs"
                        );
                    } else {
                        $.ajax({
                            type: "POST",
                            url:
                                base_url +
                                "/admin/laboratorio/micro/operacionColAlimentos",
                            data: {
                                idDetalle: idMuestra,
                            ...
                            success: function (response) {
                                ...
                                switch (response.parametro) {
                                    ...
                                    default:
                                        if (
                                            response.resultado < response.limite
                                        ) {
                                            $("#resultadoColAli").val(
                                                "<" + response.limite
                                            );
                ...
                case 70:
                    let sug2 = 0;
                    if (
                        document.getElementById("sugeridoDboIno").checked ==
                        true
                    ) {
                        sug2 = 1;
                    }
                ...
                case 78:
                    ...
                    $.ajax({
                        ...
                        url:
                            base_url +
                            "/admin/laboratorio/micro/operacionEcoli",
                        data: {
                            idLote: idLote,
                            colonia: numColonia,
                            idDetalle: idMuestra,
            ...
            switch (parseInt(response.lote[0].Id_area)) {
                ...
                case 5: // Fisicoquimicos
                    ...
                    switch (parseInt(response.lote[0].Id_tecnica)) {
                        case 152: // COT
                            ...
                            $("#abs11COT").val(
                                number_format(
                                    parseFloat(response.model.Abs1),
                                    3,
                                    ".",
                                    ""
                                )
                            ...
                            $("#abs21COT").val(
                                number_format(
                                    parseFloat(response.model.Abs2),
                                    3,
                                    ".",
                                    ""
                                )
                            ...
                            $("#abs31COT").val(
                                number_format(
                                    parseFloat(response.model.Abs3),
                                    3,
                                    ".",
                                    ""
                                )
                        ...
                        case 113:
                            ...
                            $("#fDilucion1SulfatosF").val(
                                response.model.Vol_dilucion
                            );
                            $("#fDilucion2SulfatosF").val(
                                response.model.Vol_dilucion
                            );
                            $("#volMuestra1SulfatosF").val(
                                response.model.Vol_muestra
                            );
                            $("#volMuestra2SulfatosF").val(
                                response.model.Vol_muestra
                            );
                        ...
                        case 95:
                            ...
                            if (response.model.Nitratos != null) {
                                $("#nitratosEspectro1").val(
                                    response.model.Nitratos
                                );
                            } else {
                                $("#nitratosEspectro1").val(0);
                            }
                            if (response.model.Nitritos != null) {
                                $("#nitritosEspectro1").val(
                                    response.model.Nitritos
                                );
                            } else {
                                $("#nitritosEspectro1").val(0);
                            }
                            if (response.model.Sulfuros != null) {
                                $("#sulfurosEspectro1").val(
                                    response.model.Sulfuros
                                );
                            } else {
                            ...
                            $("#volMuestraEspectro1").val(
                                response.model.Vol_muestra
                            );
                            $("#volMuestraEspectro2").val(
                                response.model.Vol_muestra
                            );
                            $("#abs1Espectro1").val(
                                number_format(
                ...
                case 15: //Solidos
                    ...
                    if (response.model.Id_parametro == 4) {
                        ...
                        document.getElementById("pscmS1").innerHTML =
                            "Masa constante c/muestra 1";
                        document.getElementById("pscmS2").innerHTML =
                            "Masa constante c/muestra 2";
                        document.getElementById("pcS1").innerHTML =
                            "Masa constante 1";
                        document.getElementById("pcS2").innerHTML =
                            "Masa constante 2";
                        document.getElementById("tituloCrisol").innerHTML =
                            "Crisol";
                        ...
                        document.getElementById("pscmS1").innerHTML =
                            "Peso constante c/muestra 1";
                        document.getElementById("pscmS2").innerHTML =
                            "Peso constante c/muestra 2";
                        document.getElementById("pcS1").innerHTML =
                            "Peso constante 1";
                        document.getElementById("pcS2").innerHTML =
                            "Peso constante 2";
                        ...
                        document.getElementById("pscmS2").innerHTML =
                            "Masa constante  c/muestra 2";
                        document.getElementById("pcS1").innerHTML =
                            "Masa constante Calcinado 1";
                        document.getElementById("pcS2").innerHTML =
                            "Masa constante Calcinado 2";
                        document.getElementById("tituloCrisol").innerHTML =
                            "Crisol";
                        ...
                        document.getElementById("pscmS2").innerHTML =
                            "Peso constante c/muestra 2";
                        document.getElementById("pcS1").innerHTML =
                            "Peso constante Calcinado 1";
                        document.getElementById("pcS2").innerHTML =
                            "Peso constante Calcinado 2";
                        document.getElementById("tituloCrisol").innerHTML =
                            "Capsula";
                    ...
                    switch (parseInt(response.model.Id_parametro)) {
                        case 3: // Directos
                            $("#resultadoModalSolidosDir").val(
                                response.model.Resultado
                            );
                            $("#inmhoffSolidosDir").val(response.model.Inmhoff);
                            $("#temperaturaLlegadaSolidosDir").val(
                                response.model.Temp_muestraLlegada
                            );
                            $("#temperaturaAnalizadaSolidosDir").val(
                                response.model.Temp_muestraAnalizada
                            );
                            $("#resultadoSolidosDir").val(
                                response.model.Resultado
                            );
                        ...
                        case 43:
                            ...
                            let res =
                                response.dif1.Resultado -
                                response.dif2.Resultado;
                            $("#preResDifSolidosDif").val(res);
                            $("#resultadoSolidosDif").val(
                                response.model.Resultado
                            );
                            $("#observacionSolidosDif").val(
                                response.model.Observacion
                            );
                            break;
                        case 88:
                            ...
                            $("#nomParametro2SolidosDif").val(response.nom2);
                            $("#val21SolidosDif").val(
                                parseFloat(response.dif2.Resultado).toFixed(2)
                            );
                            let res2 =
                                response.dif1.Resultado -
                                parseFloat(response.dif2.Resultado).toFixed(2);
                            ...
                            $("#conductividadDifSolidosDif").val(
                                response.conductividad
                            );
                            break;
                        case 46:
                            ...
                            $("#m11Solidos").val(
                                number_format(
                                    parseFloat(response.model.Masa1),
                                    4
                                )
                            );
                            $("#m12Solidos").val(
                            ...
                            $("#m21Solidos").val(
                                number_format(
                                    parseFloat(response.dif1.Masa2),
                                    4
                                )
                            );
                            $("#m22Solidos").val(
                            ...
                            $("#pcm11Solidos").val(
                                number_format(
                                    parseFloat(response.dif1.Peso_constante1),
                                    4
                                )
                            );
                            $("#pcm12Solidos").val(
                            ...
                            $("#pcm21Solidos").val(
                                number_format(
                                    parseFloat(response.dif1.Peso_constante2),
                                    4
                                )
                            );
                            $("#pcm22Solidos").val(
                            ...
                            $("#pc1Solidos").val(
                                number_format(
                                    parseFloat(response.model.Peso_muestra1),
                                    4
                                )
                            );
                            $("#pc2Solidos").val(
                            ...
                            $("#pc21Solidos").val(
                                number_format(
                                    parseFloat(response.model.Peso_muestra2),
                                    4
                                )
                            );
                            $("#pc22Solidos").val(
                            ...
                            $("#resultadoSolidos").val(
                                response.model.Resultado
                            );
                            $("#observacionSolidos").val(
                                response.model.Observacion
                            );
                            break;
                        case 48:
                        ...
                        default: // Default
                            ...
                            $("#m21Solidos").val(
                                number_format(
                                    parseFloat(response.model.Masa2),
                                    4
                                )
                            );
                            $("#m22Solidos").val(
                            ...
                            $("#pcm11Solidos").val(
                                number_format(
                                    parseFloat(response.model.Peso_constante1),
                                    4
                                )
                            );
                            $("#pcm12Solidos").val(
                            ...
                            $("#pcm21Solidos").val(
                                number_format(
                                    parseFloat(response.model.Peso_constante2),
                                    4
                                )
                            );
                            $("#pcm22Solidos").val(
                    ...
                    switch (parseInt(response.model.Id_parametro)) {
                        ...
                        case 218:
                            if (response.model.Resultado != null) {
                                ...
                                $("#cloroB1Vol").val(
                                    response.valoracion.Blanco
                                );
                                $("#cloroC1Vol").val(
                                    response.valoracion.Resultado
                                );
                                $("#cloroD1Vol").val(
                                    response.model.Factor_conversion
                                );
                        ...
                        case 11:
                            if (response.model.Resultado != null) {
                                $("#tituladosNitro1Vol").val(
                                    response.model.Titulado_muestra
                                );
                                $("#blancoNitro1Vol").val(
                                    response.model.Titulado_blanco
                                );
                                $("#molaridadNitro1Vol").val(
                                    response.model.Molaridad
                                );
                        ...
                        case 108: // Nitrogeno Amon
                            if (response.model.Resultado != null) {
                                $("#factor1ENitrogenoEVol").val(
                                    response.model.Titulado_muestra
                                );
                                $("#concentracion1ENitrogenoEVol").val(
                                    response.valoracion.Blanco
                                );
                                $("#volAñadidoStd1ENitrogenoEVol").val(
                                    response.valoracion.Resultado
                                );
                                ...
                                $("#VolAñadidoMuestra1ENitrogenoEVol").val(
                                    response.model.Vol_muestra
                                );
                                $("#volumenMuestraE1NitrogenoEVol").val(
                                    response.model.Vol_muestra
                                );
                                $("#observacionNitrogenoEVol").val(
                                    response.model.Observacion
                                );
                                $("#resultadoNitrogenoEVol").val(
                                    response.model.Resultado
                        ...
                        case 29:
                            document.getElementById(
                                "tituloModalAlcalinidad"
                            ).innerHTML = "Captura de resultados Alcalinida";
                            document.getElementById(
                                "tituloNormalidadModal"
                            ).innerHTML = "Normalidad aido sulfúrico";

                            $("#tituladoAlc1Vol").val(response.model.Titulados);
                            $("#phMuestraAlc1Vol").val(
                                response.model.Ph_muestra
                            );
                            $("#volMuestraAlc1Vol").val(
                                response.model.Vol_muestra
                            );
                            $("#normalidadAlc1Vol").val(
                                response.valoracion.Resultado
                            );
                            $("#conversionAlc1Vol").val(
                                response.model.Factor_conversion
                            );
                            $("#observacionAlcalinidadVol").val(
                                response.model.Observacion
                            );
                            $("#resultadoAlcalinidad").val(
                                response.model.Resultado
                        ...
                        case 27:
                            document.getElementById(
                                "tituloModalAlcalinidad"
                            ).innerHTML = "Captura de resultados Acidez";
                            document.getElementById(
                                "tituloNormalidadModal"
                            ).innerHTML = "Normalidad NaOH ";
                            ...
                            break;
                        case 30:
                            $("#observacionAlcalinidadToVol").val(
                                response.model.Observacion
                            );
                            $("#resultadoAlcalinidadTo").val(
                                response.model.Resultado
                ...
                case 19: //Directos
                    switch (parseInt(response.model.Id_parametro)) {
                        ...
                        case 67:
                        case 110:
                            $("#observacionDirecto").val(
                                response.model.Observacion
                            );
                            $("#lecturaUno1Directo").val(
                                response.model.Lectura1
                            );
                            $("#lecturaDos1Directo").val(
                                response.model.Lectura2
                            );
                            $("#lecturaTres1Directo").val(
                                response.model.Lectura3
                            );
                            $("#temperatura1Directo").val(
                                response.model.Temperatura
                            );
                            $("#resultadoDirecto").val(
                                response.model.Resultado
                            );
                        ...
                        case 119:
                            ...
                            $("#observacionDirectoClo").val(
                                response.model.Observacion
                            );
                            $("#volumenCloro1DirectoClo").val(
                                response.model.Vol_muestra
                            );
                            $("#lecturaUnoCloro1DirectoClo").val(
                                response.model.Lectura1
                            );
                            $("#lecturaDosCloro1DirectoClo").val(
                                response.model.Lectura2
                            );
                            $("#lecturaTresCloro1DirectoClo").val(
                                response.model.Lectura3
                            );
                            $("#promedioCloro1DirectoClo").val(
                                response.model.Promedio
                        ...
                        case 97: // temperatura
                        case 33:
                            $("#observacionDirectoTemp").val(
                                response.model.Observacion
                            );
                            $("#lecturaUno1TDirectoTemp").val(
                                response.model.Lectura1
                            );
                            $("#lecturaDos1TDirectoTemp").val(
                                response.model.Lectura2
                            );
                            $("#lecturaTres1TDirectoTemp").val(
                                response.model.Lectura3
                            );
                            $("#resultadoDirectoTemp").val(
                                response.model.Resultado
                        ...
                        case 372:
                        case 370:
                            $("#observacionDirectoColor").val(
                                response.model.Observacion
                            );
                            $("#aparente1DirectoColor").val(
                                response.model.Color_a
                            );
                            $("#verdadero1DirectoColor").val(
                                response.model.Color_v
                            );
                            $("#dilusion1DirectoColor").val(
                                response.model.Factor_dilucion
                            );
                            $("#volumen1DirectoColor").val(
                                response.model.Vol_muestra
                            );
                            $("#ph1DirectoColor").val(response.model.Ph);
                            $("#factor1DirectoColor").val(
                                response.model.Factor_correcion
                            );
                            $("#resultadoDirectoColor").val(
                                response.model.Resultado
                            );
                        ...
                        case 98:
                        case 115:
                            $("#observacionDirectoTur").val(
                                response.model.Observacion
                            );
                            $("#dilusionTurb1DirectoTur").val(
                                response.model.Factor_dilucion
                            );
                            $("#valumenTurb1DirectoTur").val(
                                response.model.Vol_muestra
                            );
                            $("#lecturaUnoTurb1DirectoTur").val(
                                response.model.Lectura1
                            );
                            $("#lecturaDosTurb1DirectoTur").val(
                                response.model.Lectura2
                            );
                            $("#lecturaTresTurb1DirectoTur").val(
                                response.model.Lectura3
                            );
                            $("#promedioTurb1DirectoTur").val(
                                response.model.Promedio
                        ...
                        case 102:
                            ...
                            $("#observacionColorDir1").val(
                                response.model.Observacion1
                            );
                            $("#observacionColorDir2").val(
                                response.model.Observacion2
                            );
                ...
                case 8: //Potable
                    ...
                    switch (parseInt(response.lote[0].Id_tecnica)) {
                        ...
                        case 251:
                            ...
                            $("#vol1Dureza").val(
                                response.model2.Vol_muestraVal1
                            );
                            $("#real1Dureza").val(
                                response.valoracion.Resultado
                            );
                            $("#conversion1Dureza").val(
                                response.model2.Factor_conversionVal1
                            );
                            $("#resInd1Dureza").val(
                                response.model2.ResultadoVal1
                            );
                        ...
                        case 103:
                            ...
                            $("#vol2Dureza").val(
                                response.model2.Vol_muestraVal2
                            );
                            $("#real2Dureza").val(
                                response.valoracion.Resultado
                            );
                            $("#conversion2Dureza").val(
                                response.model2.Factor_conversionVal2
                            );
                            $("#resInd2Dureza").val(
                                response.model2.ResultadoVal2
                            );

                            $("#edta3Dureza").val(response.model2.EdtaVal3);
                            $("#ph3Dureza").val(response.model2.Ph_muestraVal3);
                            $("#vol3Dureza").val(
                                response.model2.Vol_muestraVal3
                            );
                            $("#real3Dureza").val(
                                response.valoracion.Resultado
                            );
                            $("#conversion3Dureza").val(
                                response.model2.Factor_conversionVal3
                            );
                            $("#resInd3Dureza").val(
                                response.model2.ResultadoVal3
                            );
                ...
                case 3:
                    switch (parseInt(response.model.Id_parametro)) {
                        ...
                        case 137:
                            ...
                            document.getElementById(
                                "tituloColiformes"
                            ).innerText = "Prueba confirmativa 24hrs";
                            if (parseInt(response.model.Id_parametro) == 137) {
                                document.getElementById(
                                    "tituloColiformes"
                                ).innerHTML =
                                    "Prueba confirmativa 24hrs / 48hrs";
                            }
                            ...
                            switch (parseInt(response.model.Id_parametro)) {
                                case 35:
                                    ...
                                    $("#con12Col").val(
                                        response.model.Confirmativa3
                                    );
                                    $("#con13Col").val(
                                        response.model.Confirmativa4
                                    );
                                    $("#con14Col").val(
                                        response.model.Confirmativa5
                                    );
                                    $("#con15Col").val(
                                        response.model.Confirmativa6
                                    );
                                    $("#con16Col").val(
                                        response.model.Confirmativa7
                                    );
                                    $("#con17Col").val(
                                        response.model.Confirmativa8
                                    );
                                    $("#con18Col").val(
                                        response.model.Confirmativa9
                                    );
                                    ...
                                    $("#con3Col").val(
                                        response.model.Confirmativa12
                                    );
                                    $("#con4Col").val(
                                        response.model.Confirmativa13
                                    );
                                    $("#con5Col").val(
                                        response.model.Confirmativa14
                                    );
                                    $("#con6Col").val(
                                        response.model.Confirmativa15
                                    );
                                    $("#con7Col").val(
                                        response.model.Confirmativa16
                                    );
                                    $("#con8Col").val(
                                        response.model.Confirmativa17
                                    );
                                    $("#con9Col").val(
                                        response.model.Confirmativa18
                                    );
                                    break;
                                case 137:
                                    $("#ajo").attr("hidden", false);
                            ...
                            $("#negativos1Col").val(
                                response.model.Tubos_negativos
                            );
                            $("#positivos1Col").val(
                                response.model.Tubos_positivos
                            );
                        ...
                        case 71:
                            ...
                            break;
                        case 70:
                            $("#oxiInicialIno1Dbo").val(
                                response.model.Oxigeno_inicial
                            );
                            $("#oxiFinalIno1Dbo").val(
                                response.model.Oxigeno_final
                            );
                            $("#volInoMuestra1Dbo").val(
                                response.model.Vol_muestra
                            );
                            $("#oxigenoDisueltoIniIno1Dbo").val(
                                response.model.Oxigeno_disueltoini
                            );
                            $("#oxigenoDisueltoFinIno1Dbo").val(
                                response.model.Oxigeno_disueltofin
                            );
                            $("#volTotalFrascoIno1Dbo").val(
                                response.model.Vol_total_frasco
                            );
                            $("#volIno1Dbo").val(response.model.Vol_inoculo);
                            $("#volMuestraSiemIno1Dbo").val(
                                response.model.Vol_muestra_siembra
                            );
                            $("#porcentajeIno1Dbo").val(
                                response.model.Porcentaje_dilucion
                            );
                            $("#volWinkerIno1Dbo").val(
                                response.model.Vol_winker
                            );
                            $("#noBotellaIno1Dbo").val(
                                response.model.Botella_od
                            );
                            $("#noBotellaFin1Dbo").val(
                                response.model.Botella_fin
                            );
                            $("#phInicialIno1Dbo").val(
                                response.model.Ph_inicial
                            );
                        ...
                        case 78:
                            ...
                            $("#vp1Ecoli").val(response.convinaciones.Vp);
                            $("#citrato1Ecoli").val(
                                response.convinaciones.Citrato
                            );
                            $("#bgn1Ecoli").val(response.convinaciones.BGN);
                            $("#indol2Ecoli").val(
                                response.convinaciones.Indol2
                            );
                            $("#rm2Ecoli").val(response.convinaciones.Rm2);
                            $("#vp2Ecoli").val(response.convinaciones.Vp2);
                            $("#citrato2Ecoli").val(
                                response.convinaciones.Citrato2
                            );
                            $("#bgn2Ecoli").val(response.convinaciones.BGN2);
                            $("#observacionEcoli").val(
                                response.model.observacion
        ...
        success: function (response) {
            ...
            $.each(response.model, function (key, item) {
                ...
                switch (parseInt(response.lote[0].Id_area)) {
                        ...
                        switch (parseInt(item.Id_parametro)) {
                            case 152:
                                ...
                                tab +=
                                    ...
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaCOT">Capturar</button>';
                                break;
                            case 113:
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaSulfatos">Capturar</button>';
                                break;
                            case 79:
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                    ...
                    case 13: // G&A
                        tab +=
                            ...
                            '" onclick="getDetalleMuestra(' +
                            item.Id_detalle +
                            ');" data-toggle="modal" data-target="#modalCapturaGA">Capturar</button>';
                        break;
                    case 15: // Solidos
                        switch (parseInt(item.Id_parametro)) {
                            case 3: // Directos
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaSolidosDir">Capturar</button>';
                                break;
                            case 47: // Por diferencia
                            case 88:
                            case 44:
                            ...
                            default: // Default
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaSolidos">Capturar</button>';
                                break;
                        }
                        break;
                    case 14: // Volumetria
                        switch (parseInt(item.Id_parametro)) {
                            ...
                            case 218:
                                ...
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCloroVol">Capturar</button>';
                                break;
                            case 6: // Dqo
                            case 161:
                                ...
                                if (response.aux.Tecnica == 2) {
                                    tab +=
                                        ...
                                        '" onclick="getDetalleMuestra(' +
                                        item.Id_detalle +
                                        ');" data-toggle="modal" data-target="#modalDqoVol">Capturar</button>';
                                } else {
                                    tab +=
                                        '<td><input hidden id="idMuestra' +
                                        item.Id_detalle +
                            ...
                            case 11:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaNitrogenoVol">Capturar</button>';
                                break;
                            case 28: // Alcalinidad
                            case 29:
                            case 27:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaAlcalinidadVol">Capturar</button>';
                                break;
                            case 30:
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaAlcalinidadToVol">Capturar</button>';
                                break;
                            case 108: // Nitrogeno Amon
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaNitrogenoEVol">Capturar</button>';
                                break;
                            default: // Default Directos
                                // tab += '<td><input hidden id="idMuestra' + item.Id_detalle + '" value="' + item.Id_detalle + '"><button '+status+' type="button" class="btn btn-'+color+'" onclick="getDetalleMuestra(' + item.Id_detalle + ',1);" data-toggle="modal" data-target="#modalCapturaSolidos">Capturar</button>';
                                break;
                        ...
                        switch (parseInt(item.Id_parametro)) {
                            ...
                            case 110:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDirecto">Capturar</button>';
                                break;
                            case 218: // Cloruros
                            case 119:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDirectoClo">Capturar</button>';
                                break;
                            case 97: // temperatura
                            case 33:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDirectoTemp">Capturar</button>';
                                break;
                            case 66: //102
                            case 65:
                            case 120:
                            ...
                            case 370:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDirectoColor">Capturar</button>';
                                break;
                            case 89:
                            case 98:
                            case 115:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDirectoTur">Capturar</button>';
                                break;
                            case 238:
                            case 360:
                            case 241:
                            ...
                            case 266:
                                ...
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDirectoDef">Capturar</button>';
                                break;
                            case 131:
                                dec = 4;
                                tab +=
                        ...
                        switch (parseInt(item.Id_parametro)) {
                            ...
                            case 103:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDureza">Capturar</button>';
                                break;
                            case 252:
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalDurezaDif">Capturar</button>';
                                break;
                            default:
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalPotable">Capturar</button>';
                                break;
                        }
                        break;
                    case 6: //Mb
                        ...
                        switch (parseInt(item.Id_parametro)) {
                            ...
                            case 137:
                                ...
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaCol">Capturar</button>';
                                break;
                            case 253: //Enterococos
                                ...
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaEnt">Capturar</button>';
                                break;
                            case 5: //Dbo
                            case 71:
                                if (item.Id_control == 5) {
                                    tab +=
                                        ...
                                        '" onclick="getDetalleMuestra(' +
                                        item.Id_detalle +
                                        ');" data-toggle="modal" data-target="#modalCapturaDboBlanco">Capturar</button>';
                                } else {
                                    tab +=
                                        '<td><input hidden id="idMuestra' +
                                        item.Id_detalle +
                                        ...
                                        '" onclick="getDetalleMuestra(' +
                                        item.Id_detalle +
                                        ');" data-toggle="modal" data-target="#modalCapturaDbo">Capturar</button>';
                                }
                                break;
                            case 70:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaDboIno">Capturar</button>';
                                break;
                            case 16: //HH
                                tab +=
                                    '<td><input hidden id="idMuestra' +
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalCapturaHH">Capturar</button>';
                                break;
                            case 135: //Coliformes alimentos
                            case 133:
                            case 132:
                            case 134:
                                tab +=
                                    ...
                                    '" onclick="getDetalleMuestra(' +
                                    item.Id_detalle +
                                    ');" data-toggle="modal" data-target="#modalColiformesAlimentos">Capturar</button>';
                                break;
                            case 78:
                                let temp78 = "";
                                let data = [
                                ...
                                for (
                                    ...
                                    tab += '<div class="col-md-12">';
                                    tab +=
                                        '<button type="button" id="col' +
                                        i +
                                        '" ' +
                                        status +
                                        ' class="' +
                                        clase +
                                        '" onclick="getDetalleEcoli(' +
                                        item.Id_detalle +
                                        "," +
                                        (i + 1) +
                                        "," +
                                        indice[contador] +
                                        ');" data-toggle="modal" data-target="#modalEcoli">Capturar</button>';
                                    tab += "<label>";
                                    tab +=
                                        "&nbsp Colonia &nbsp" +
                                        (i + 1) +
                                    ...
                                    tab +=
                                        '<input type="text" id="resultColonia" value="' +
                                        temp78 +
                                        '">';
                                    tab += "</div>";
                                    tab += '</div">';
                ...
                tab +=
                    '<td style="' +
                    estiloH +
                    '"><input disabled style="width: 150px;" value="' +
                    item.Codigo +
                    '"></td>';
                tab +=
                    '<td style="' +
                ...
                tab +=
                    '<td style="' +
                    estiloH +
                    '"><button class="btn-warning" onclick="getHistorial(' +
                    item.Id_codigo +
                ...
                tab +=
                    '<td style="' +
                    estiloH +
                    '"><button class="btn-info" onclick="getImagenMuestra(' +
                    item.Id_analisis +
                    ')" data-toggle="modal" data-target="#modalImgFoto"><i class="voyager-photo"></i></button></td>';
                tab += "</tr>";
                contitem++;
            });
            tab += "    </tbody>";
        ...
        success: function (response) {
            ...
            for (let i = 0; i < response.model.length; i++) {
                ...
                tab +=
                    ...
                    response.idCodigo[i] +
                    '" name="stdCkAsignar" onclick="contarCheckbox()"></td>';
                tab +=
                    '<td style="' +
                    estiloH +
                    '">' +
            ...
            $("div.toolbar").html(
                '<button onclick="setMuestraLote()" id="btnAsignarMuestra" class="btn-success"><i class="fas fa-paper-plane"></i></button> <button onclick="selecionarCkeck()" class="btn-info"><i class="fas fa-check-double"></i></button>'
            );
        },
    });
}
...
function setLote() {
    if ($("#parametro").val() != "0" && $("#fechaLote").val() != "") {
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.model.length > 0) {
                        if (
                            confirm(
                                "Ya tienes un lote en esta fecha, ¿Quieres crear otro lote?"
                            )
                        ) {
                            $.ajax({
                                type: "POST",
                        ...
                        $.ajax({
                            ...
                            data: {
                                id: $("#parametro").val(),
                                fecha: $("#fechaLote").val(),
                                _token: $('input[name="_token"]').val(), //No me esta agarrando el token
                            },
                            dataType: "json",
                            async: false,
                            success: function (response) {
        ...
        alert(
            "Para buscar un lote tienes que seleccionar un parametro y una fecha"
        );
    }
}
function getLote() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response.model, function (key, item) {
                    ...
                    tab += "<td>";
                    tab +=
                        '     <button class="btn-info" onclick="exportBitacora(' +
                        item.Id_lote +
                        ')"><i class="voyager-download"></i></button><br>';
                    tab +=
                        '     <button onclick="getDetalleLote(' +
                        item.Id_lote +
                        ",'" +
                        item.Parametro +
                        '\')" class="btn-info" id="btnEditarBitacora"><i class="voyager-edit"></i></button>';
                    tab += "</td>";
                    tab += "</tr>";
                    cont++;
                });
...
function getPendientes() {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            tab +=
                '<table class="table table-sm" style="font-size:10px" id="tablePendientes">';
            ...
            for (let i = 0; i < model.length; i++) {
                ...
                diasDiferencia = Math.ceil(
                    (Hoy - fechaRecepcion) / (1000 * 60 * 60 * 24)
                );

                estilohistorial =
                    model[i][4] == 1 ? "background-color:#e5e5ff;" : "";
...
function getDetalleElegido(folio) {
    $.ajax({
        ...
        success: function (response) {
            ...
            if (
                elegidoCloruro[0] != null &&
                elegidoCloruro[0].Resultado2 != null
            ) {
            ...
            if (
                elegidoConductividad[0] != null &&
                elegidoConductividad[0].Resultado2 != null
            ) {
                $("#conductividadParametro").html(
                    elegidoConductividad[0].Resultado2
                );
            } else {
                $("#conductividadParametro").html("N.A");
            }
            if (
                elegidoPh[0] != "undefined" &&
                elegidoPh[0].Resultado2 != null
            ) {
