        ...
        case 12:
          switch (parseInt($("#parametro").val())) {
            ...
            case 12:
              ...
              //     response.plantilla[0]
              // );
              if (
                response.Bitacora &&
                (response.Bitacora.Sembrado ||
                  response.Bitacora.Fecha_resiembra ||
                  response.Bitacora.Num_tubo ||
                  response.Bitacora.Bitacora ||
                  response.Bitacora.Preparacion_pre ||
                  response.Bitacora.Lectura_pre ||
                  response.Bitacora.Lectura_pre2 ||
                  response.Bitacora.Medio_con ||
