  ...
  $("#btnColiformes").click(function () {
    ...
    $.ajax({
      ...
      data: {
        ...
        lectura2: $("#pruebaPresuntiva_lectura2").val(),
        Ajolote: $("#MEDIO").val(),
    ...
    case 8:
      ...
      switch (parseInt($("#parametro").val())) {
        ...
        case 218:
          ...
          document.getElementById("divTituloTrazableCloros").innerHTML =
            "mL de K2Cr2O7 Trazable";
          $("#secctionCloro").show();
          break;
        case 64:
          document.getElementById("divTitulo1Cloros").innerHTML =
...
function eliminarMuestra() {
  if (idMuestra != 0) {
    $.ajax({
      type: "POST",
      url: base_url + "/admin/laboratorio/analisis/eliminarMuestra",
      data: {
        idMuestra: idMuestra,
        idLote: idLote,
        _token: $('input[name="_token"]').val(),
  ...
  switch (parseFloat($("#parametro").val())) {
    ...
    case 161: // DQO
      ...
      prom =
        ...
        3;
      res =
        (parseFloat(volk2) * parseFloat(concentracion) * parseFloat(factor)) /
        prom;
    ...
    case 103:
      ...
      prom1 =
        ...
        3;
      res1 =
        solucion1 / (prom1.toFixed(4) - parseFloat($("#blancoResDur").val()));
      ...
      prom2 =
        ...
        3;
      res2 =
        solucion2 / (prom2.toFixed(4) - parseFloat($("#blancoResDur").val()));
      ...
      prom3 =
        ...
        3;
      res3 =
        solucion3 / (prom3.toFixed(4) - parseFloat($("#blancoResDur").val()));
...
function setDetalleGrasas() {
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/setDetalleGrasas",
    data: {
      id: idLote,
      temp1: $("#tempGA1").val(),
...
function setBitacora() {
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/setBitacora",
    data: {
      id: idLote,
...
var setObservacion = function (id = "", id2 = "na", id3 = "na") {
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/setObservacion",
    data: {
      idLote: idLote,
      idMuestra: idMuestra,
      observacion: $("#" + id).val(),
...
function setLiberar() {
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/setLiberar",
    data: {
      idMuestra: idMuestra,
      idLote: idLote,
      _token: $('input[name="_token"]').val(),
...
function setControlCalidad() {
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/setControlCalidad",
    data: {
      idMuestra: idMuestra,
      idLote: idLote,
...
function exportBitacora(id) {
  window.open(
    base_url + "/admin/laboratorio/analisis/bitacora/impresion/" + id
  );
}
function getDetalleLote(id, parametro) {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getDetalleLote",
    data: {
      id: id,
      _token: $('input[name="_token"]').val(),
    },
    ...
    success: function (response) {
          ...
          switch (parseInt($("#parametro").val())) {
            ...
            case 12:
              ...
              $("#sembrado_fechaResiembra").val(
                formatDate(response.Bitacora.Fecha_resiembra)
              );
              ...
              $("#pruebaPresuntiva_preparacion").val(
                response.Bitacora.Preparacion_pre
              );
              $("#pruebaPresuntiva_lectura").val(response.Bitacora.Lectura_pre);
              $("#pruebaPresuntiva_lectura2").val(
                response.Bitacora.Lectura_pre2
              );

              $("#MEDIO").val(response.Bitacora.Medio_con);
              $("#pruebaConfirmativa_preparacion").val(
                response.Bitacora.Preparacion_con
              );
      ...
      summer.innerHTML =
        '<div id="summernote">' + response.plantilla[0].Texto + "</div>";
    ...
    case 5:
      switch (parseInt($("#parametro").val())) {
        ...
        case 619:
          $.ajax({
            type: "POST",
            url: base_url + "/admin/laboratorio/analisis/setDetalleMuestra",
            data: {
              idLote: idLote,
              idMuestra: idMuestra,
              ABS: $("#abs1COT").val(),
        ...
        default:
          $.ajax({
            type: "POST",
            url: base_url + "/admin/laboratorio/analais/setDetalleMuestra",
            data: {
              idLote: idLote,
              idMuestra: idMuestra,
            ...
            success: function (response) {
              ...
              $("#fDilucionEspectro1").val(
                parseFloat(response.model.Vol_dilucion).toFixed(3)
              );
        ...
        case 161:
          if (idTecnica == 2) {
            $.ajax({
              type: "POST",
              url:
                base_url + "/admin/laboratorio/analisis/setDetalleMuestra",
              data: {
                idLote: idLote,
                idMuestra: idMuestra,
                sw: idTecnica,
              ...
              success: function (response) {
                ...
                alert("Datos guardados");
                $("#resultadoDqoVol").val(
                  number_format(response.model.Resultado.toFixed(2), 2, ".", "")
                );
              },
            });
          } else {
      ...
      switch (parseInt($("#parametro").val())) {
        ...
        case 365:
          $.ajax({
            ...
            dataType: "json",
            success: function (response) {
              // se debe obtener el valor de resultado directo
              let resultado = parseFloat(response.model.Resultado);

              function redondearColor(valor) {
                if (valor >= 1 && valor <= 50) {
                  return Math.round(valor); // Redondeo a 1 unidad
                } else if (valor >= 51 && valor <= 100) {
                  return Math.round(valor / 5) * 5;
                } else if (valor >= 101 && valor <= 250) {
              ...
              let resultadoRedondeado = redondearColor(resultado);

              $("#resultadoDirectoColor").val(response.model.Resultado);

              $("#resultadoDirectoColor2").val(resultadoRedondeado);
        ...
        case 115:
          let resultado = parseFloat($("#resultadoDirectoTur").val());
          ...
          const rangos = [
            ...
            { min: 1000, max: Infinity, multiplicador: 100 },
          ];

          let multiplicador = 0;
          for (let i = 0; i < rangos.length; i++) {
            if (resultado >= rangos[i].min && resultado < rangos[i].max) {
              multiplicador = rangos[i].multiplicador;
              break;
            }
          }

          let resultadoAproximado =
            Math.round(resultado / multiplicador) * multiplicador;
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              $("#resultadoDirectoTur").val(
                number_format(parseFloat(response.model.Resultado), 3, ".", "")
              );

              $("#resultadoDirectoTur2").val(response.model.Aux);
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if (response.success && response.model2) {
                $("#resultadoVidrio1").val(response.model2.Resultado);
                $("#resultadoVidrio2").val(response.model2.Resultado2);
                $("#resultadoVidrio3").val(response.model2.Resultado_aux);
                $("#resultadoVidrio4").val(response.model2.Resultado_aux2);
                $("#resultadoVidrio5").val(response.model2.Resultado_aux3);
                $("#resultadoVidrio6").val(response.model2.Resultado_aux4);
              } else {
                console.error(
...
function getDetalleMuestra(id) {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getDetalleMuestra",
    data: {
      id: $("#idMuestra" + id).val(),
      idLote: idLote,
      _token: $('input[name="_token"]').val(),
      ...
      switch (parseInt(response.lote[0].Id_area)) {
        ...
        case 5: // Fisicoquimicos
          ...
          switch (parseInt(response.lote[0].Id_tecnica)) {
            ...
            case 619:
              ...
              $("#abs11COT").val(
                number_format(parseFloat(response.model.Abs1), 3, ".", "")
              );
              $("#abs21COT").val(
                number_format(parseFloat(response.model.Abs2), 3, ".", "")
              );
              $("#abs31COT").val(
                number_format(parseFloat(response.model.Abs3), 3, ".", "")
              );
              $("#resultadoCOT").val(response.model.Resultado);
              break;
            case 113:
        ...
        case 15: //Solidos
          ...
          switch (parseInt(response.model.Id_parametro)) {
            ...
            case 46:
              ...
              $("#m11Solidos").val(
                number_format(parseFloat(response.model.Masa1), 4)
              );
              $("#m12Solidos").val(
                number_format(parseFloat(response.model.Masa1), 4)
              );
              $("#m21Solidos").val(
                number_format(parseFloat(response.dif1.Masa2), 4)
              );
              $("#m22Solidos").val(
                number_format(parseFloat(response.dif1.Masa2), 4)
              );
              $("#pcm11Solidos").val(
                number_format(parseFloat(response.dif1.Peso_constante1), 4)
              );
              $("#pcm12Solidos").val(
                number_format(parseFloat(response.dif1.Peso_constante1), 4)
              );
              $("#pcm21Solidos").val(
                number_format(parseFloat(response.dif1.Peso_constante2), 4)
              );
              $("#pcm22Solidos").val(
                number_format(parseFloat(response.dif1.Peso_constante2), 4)
              );
              $("#pc1Solidos").val(
                number_format(parseFloat(response.model.Peso_muestra1), 4)
              );
              $("#pc2Solidos").val(
                number_format(parseFloat(response.model.Peso_muestra1), 4)
              );
              $("#pc21Solidos").val(
                number_format(parseFloat(response.model.Peso_muestra2), 4)
              );
              $("#pc22Solidos").val(
                number_format(parseFloat(response.model.Peso_muestra2), 4)
              );
            ...
            default: // Default
              ...
              $("#m21Solidos").val(
                number_format(parseFloat(response.model.Masa2), 4)
              );
              $("#m22Solidos").val(
                number_format(parseFloat(response.model.Masa2), 4)
              );
              $("#pcm11Solidos").val(
                number_format(parseFloat(response.model.Peso_constante1), 4)
              );
              $("#pcm12Solidos").val(
                number_format(parseFloat(response.model.Peso_constante1), 4)
              );
              $("#pcm21Solidos").val(
                number_format(parseFloat(response.model.Peso_constante2), 4)
              );
              $("#pcm22Solidos").val(
                number_format(parseFloat(response.model.Peso_constante2), 4)
              );
        ...
        case 14: // Volumetria
          switch (parseInt(response.model.Id_parametro)) {
            ...
            case 28:
            case 29:
              document.getElementById("tituloModalAlcalinidad").innerHTML =
                "Captura de resultados Alcalinida";
              document.getElementById("tituloNormalidadModal").innerHTML =
                "Normalidad aido sulfúrico";
            ...
            case 30:
              ...
              $("#resultadoAlcalinidadTo").val(response.model.Resultado);
              //console.log("eje",response.dif1);
              if (response.dif1.Resultado <= 10.07) {
                $("#resFeno").val(0);
              } else {
                $("#resFeno").val(response.dif1.Resultado);
              }
              if (response.dif2.Resultado <= 10.07) {
                $("#resAnaranjado").val(0);
              } else {
        ...
        case 19: //Directos
          switch (parseInt(response.model.Id_parametro)) {
            ...
            case 173:
              ...
              $("#observacionVidrio").val(response.model.Observacion);
        ...
        case 3:
          switch (parseInt(response.model.Id_parametro)) {
            ...
            case 137:
              ...
              document.getElementById("tituloColiformes").innerText =
                "Prueba confirmativa 24hrs";
              if (parseInt(response.model.Id_parametro) == 137) {
                document.getElementById("tituloColiformes").innerHTML =
...
function getCapturaLote() {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getCapturaLote",
    data: {
      idLote: idLote,
      _token: $('input[name="_token"]').val(),
    },
    ...
    success: function (response) {
      ...
      $.each(response.model, function (key, item) {
        ...
        estiloH =
          parseInt(item.Historial) == 1 ? "background-color:#e5e5ff;" : "";
        console.log(estiloH);
        switch (parseInt(response.lote[0].Id_area)) {
          case 16: // Espectrofotometria
          case 5: // Fisicoquimicos
        ...
        if (item.Id_control != 1) {
          tab +=
            '<br> <small class="text-danger">' + item.Control + "</small></td>";
        } else {
          tab +=
            '<br> <small class="text-info">' + item.Control + "</small></td>";
        }
        tab +=
          '<td style="' +
          estiloH +
        ...
        switch (parseInt(item.Id_parametro)) {
          ...
          default:
            ...
            if (item.Observacion != null) {
              tab +=
                '<td style="' + estiloH + '">' + item.Observacion + "</td>";
            } else {
              tab += '<td style="' + estiloH + '"></td>';
            }
            break;
      ...
      $("#tabCaptura tbody").on("click", "tr", function () {
        if ($(this).hasClass("selected")) {
          ...
          let folioElegido = $(this)
            .find("td:first")[0]
            .parentElement.children[1].firstElementChild.getAttribute("value");
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response.model) {
        ...
        $("#divImagen").html(
          `<h1> 📸 No hay imagen disponible 📸. Favor de verifiacarlo en Recepcion </h1>`
        );
      }
    },
    ...
    complete: function () {
      $("#spinner").hide(); // Ocultamos el spinner cuando termine la petición
      $("#modalImgFoto").modal("show"); // Mostramos el modal
    },
  });
}
...
function setMuestraLote() {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/setMuestraLote",
    data: {
      codigos: codigos,
      idLote: idLote,
      _token: $('input[name="_token"]').val(),
...
function getMuestraSinAsignar() {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getMuestraSinAsignar",
    data: {
      idLote: idLote,
      idParametro: $("#parametro").val(),
    ...
    dataType: "json",
    success: function (response) {
      // Aquí puedes calcular días de análisis si quieres
      let mensaje = "";
      let color = "";
      //console.log(response);
      ...
      $("#porAsingarLote").val(response.codigos.length);
      ...
      tab +=
        "<th>Fecha recepción<br><input type='date' id='filterFecha' class='form-control form-control-sm' placeholder='Filtrar'></th>";
      tab += "<th>Dias Analisis</th>";
      tab += "</tr></thead>";
      tab += "<tbody>";
      //console.log(response.codigos);
      response.codigos.forEach(function (codigo) {
        // Concatenar puntos y horas si son arrays
        let puntos = codigo.Puntos.join(", ");
        let horas = codigo.HorasRecepcion.join(", ");

        // Concatenar puntos y horas si son arrays
        let diasA = codigo.Diasanalisis; // aquí es un número
        let fechaRep = new Date(codigo.HorasRecepcion); // convertir string a fecha
        let hoy = new Date(); // fecha actual

        // Calcular diferencia en días
        let diasD = Math.ceil((hoy - fechaRep) / (1000 * 60 * 60 * 24));
        ...
        tab += "<tr>";
        tab += `<td><input type="checkbox" value="${codigo.IdCodigo}" name="stdCkAsignar" onclick="contarCheckbox()"></td>`;
        tab += `<td>${codigo.Codigo}</td>`;
        tab += `<td>${codigo.Clave_norma ?? ""}</td>`;
        tab += `<td>${puntos}</td>`;
        tab += `<td>${horas}</td>`;
      ...
      let table = $("#tabAsignar").DataTable({
        ordering: false,
        paging: false,
        language: {
          lengthMenu: "# _MENU_ por pagina",
      ...
      $("#filterFecha").on("change", function () {
        table
          .column(4) // 0=Op, 1=#Muestra, 2=Norma, 3=Punto, 4=Fecha recepción
          .search(this.value)
          .draw();
      });

      $("div.toolbar").html(
        '<button onclick="setMuestraLote()" id="btnAsignarMuestra" class="btn-success"><i class="fas fa-paper-plane"></i></button> ' +
          '<button onclick="selecionarCkeck()" class="btn-info"><i class="fas fa-check-double"></i></button>'
      );
    },
  });
}
...
function setLote() {
  if ($("#parametro").val() != "0" && $("#fechaLote").val() != "") {
    if (confirm("¿Estas seguro de crear el lote?")) {
      $.ajax({
        type: "POST",
        url: base_url + "/admin/laboratorio/analisis/getLote",
        data: {
          id: $("#parametro").val(),
          fecha: $("#fechaLote").val(),
          _token: $('input[name="_token"]').val(),
        ...
        success: function (response) {
          if (response.model.length > 0) {
            if (
              ...
              $.ajax({
                type: "POST",
                url: base_url + "/admin/laboratorio/analisis/setLote",
                data: {
                  id: $("#parametro").val(),
                  fecha: $("#fechaLote").val(),
                  _token: $('input[name="_token"]').val(),
      ...
      success: function (response) {
        ...
        $.each(response.model, function (key, item) {
          ...
          switch (parseInt($("#parametro").val())) {
            case 6:
              tab +=
                "<td>" + item.Parametro + " (" + response.aux[cont] + ")</td>";
              break;
            default:
...
function getPendientes() {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getPendientes",
    data: {
      _token: $('input[name="_token"]').val(),
    },
    dataType: "json",
    ...
    success: function (response) {
      ...
      tab += "<th>Empresa</th>";
      tab += "<th>Días Análisis</th>";
      tab += "</tr>";
      tab += "</thead>";
      tab += "<tbody>";

      codigos.forEach((codigo) => {
        // Tomamos la primera fecha de recepción si hay varias
        let fechaRecepcion = new Date(codigo.HorasRecepcion[0] ?? null);
        let hoy = new Date();
        let diasAnalisis = codigo.Diasanalisis ?? 0;
        let diasDiferencia = Math.ceil(
        ...
        if (diasAnalisis === 0) {
          mensaje = "Sin Configurar";
          color = "bg-info";
        } else if (diasDiferencia < diasAnalisis) {
          color = "bg-success";
        ...
        tab += "<tr>";
        tab += "<td>" + codigo.Codigo + "</td>";
        tab += "<td>" + codigo.idparametro + "</td>";
        tab += "<td>" + (codigo.HorasRecepcion[0] ?? "") + "</td>";
        tab += "<td>" + (codigo.Empresa[0] ?? "") + "</td>";
        tab += '<td class="' + color + '">' + mensaje + "</td>";
        tab += "</tr>";
      });
...
function getHistorial(id) {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getHistorial",
    data: {
      idLote: idLote,
      idCodigo: id,
      _token: $('input[name="_token"]').val(),
...
function getUltimoLote() {
  ...
  $.ajax({
    type: "POST",
    url: base_url + "/admin/laboratorio/analisis/getUltimoLote",
    data: {
      id: $("#parametro").val(),
      _token: $('input[name="_token"]').val(),
    },
...
function getDetalleElegido(folio) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      switch (parseInt(response.idParametro)) {
        case 173:
          if (elegidoConductividad != null) {
            $("#conductividadParametro").html(elegidoConductividad);
          } else {
            $("#conductividadParametro").html("N.A");
          }
          if (elegidoPh != null) {
            $("#phParametro").html(elegidoPh.Promedio);
          } else {
            $("#phParametro").html("N.A");
          }
          let burbuja = "";
          if (response.vibrio.Burbujas == 0) {
            burbuja = "No";
          } else {
            burbuja = "Si";
          }
...
function porcentajeE(valor) {
  ...
  $.ajax({
    url: base_url + "/admin/laboratorio/analisis/PorcentaejeE",
    type: "POST",
    data: data,
    success: function (response) {
